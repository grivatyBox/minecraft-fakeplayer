...
public class EntitySheep extends EntityAnimal implements IShearable {
    ...
    public EntitySheep getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        ...
        if (entitysheep != null) {
            entitysheep.setColor(this.getOffspringColor(worldserver, this, (EntitySheep) entityageable));
        }
    ...
    private EnumColor getOffspringColor(WorldServer worldserver, EntitySheep entitysheep, EntitySheep entitysheep1) {
    ...
    private static CraftingInput makeCraftInput(EnumColor enumcolor, EnumColor enumcolor1) {
