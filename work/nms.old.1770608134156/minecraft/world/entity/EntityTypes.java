...
public class EntityTypes<T extends Entity> implements FeatureElement, EntityTypeTest<Entity, T> {
    ...
    public static final EntityTypes<Creaking> CREAKING = register("creaking", EntityTypes.Builder.of(Creaking::new, EnumCreatureType.MONSTER).fireImmune().sized(0.9F, 2.7F).eyeHeight(2.3F).clientTrackingRange(8).requiredFeatures(FeatureFlags.WINTER_DROP));
    public static final EntityTypes<CreakingTransient> CREAKING_TRANSIENT = register("creaking_transient", EntityTypes.Builder.of(CreakingTransient::new, EnumCreatureType.MONSTER).noSave().noSummon().fireImmune().sized(0.9F, 2.7F).eyeHeight(2.3F).clientTrackingRange(8).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }), EnumCreatureType.MISC).noLootTable().sized(1.375F, 0.5625F).eyeHeight(0.5625F).clientTrackingRange(10).requiredFeatures(FeatureFlags.WINTER_DROP));
