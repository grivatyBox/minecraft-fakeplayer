...
public class DataConverterRegistry {
    ...
    private static void addFixers(DataFixerBuilder datafixerbuilder) {
        ...
        datafixerbuilder.addFixer(new AddFieldFix(schema268, DataConverterTypes.PLAYER, "style", (dynamic) -> {
            return dynamic.createString("minecraft:default");
        }, new String[]{"locator_bar_icon"}));
        datafixerbuilder.addFixer(new AddFieldFix(schema268, DataConverterTypes.ENTITY, "style", (dynamic) -> {
            return dynamic.createString("minecraft:default");
        }, new String[]{"locator_bar_icon"}));
        Schema schema269 = datafixerbuilder.addSchema(4531, V4531::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema269, "Added Copper Golem", DataConverterTypes.ENTITY));
        Schema schema270 = datafixerbuilder.addSchema(4532, V4532::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema270, "Added Copper Golem Statue Block Entity", DataConverterTypes.BLOCK_ENTITY));
        Schema schema271 = datafixerbuilder.addSchema(4533, V4533::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema271, "Added Shelf", DataConverterTypes.BLOCK_ENTITY));
        Schema schema272 = datafixerbuilder.addSchema(4535, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new CopperGolemWeatherStateFix(schema272));
        Schema schema273 = datafixerbuilder.addSchema(4537, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new ChunkDeleteLightFix(schema273));
        Schema schema274 = datafixerbuilder.addSchema(4541, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(DataConverterBlockRename.create(schema274, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
        datafixerbuilder.addFixer(DataConverterItemName.create(schema274, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
        Schema schema275 = datafixerbuilder.addSchema(4543, V4543::new);

        datafixerbuilder.addFixer(new DataConverterAddChoices(schema275, "Added Mannequin", DataConverterTypes.ENTITY));
        Schema schema276 = datafixerbuilder.addSchema(4544, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new LegacyWorldBorderFix(schema276));
        Schema schema277 = datafixerbuilder.addSchema(4548, DataConverterRegistry.SAME_NAMESPACED);

        datafixerbuilder.addFixer(new WorldSpawnDataFix(schema277));
        datafixerbuilder.addFixer(new PlayerRespawnDataFix(schema277));
    }
