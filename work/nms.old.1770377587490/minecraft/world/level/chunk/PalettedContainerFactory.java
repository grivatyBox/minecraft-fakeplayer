...
public record PalettedContainerFactory(Strategy<IBlockData> blockStatesStrategy, IBlockData defaultBlockState, Codec<DataPaletteBlock<IBlockData>> blockStatesContainerCodec, Strategy<Holder<BiomeBase>> biomeStrategy, Holder<BiomeBase> defaultBiome, Codec<PalettedContainerRO<Holder<BiomeBase>>> biomeContainerCodec, Codec<DataPaletteBlock<Holder<BiomeBase>>> biomeContainerCodecRW) {
    ...
    public static PalettedContainerFactory create(IRegistryCustom iregistrycustom) {
        ...
        return new PalettedContainerFactory(strategy, iblockdata, DataPaletteBlock.codecRW(IBlockData.CODEC, strategy, iblockdata), strategy1, holder_c, DataPaletteBlock.codecRO(iregistry.holderByNameCodec(), strategy1, holder_c), DataPaletteBlock.codecRW(iregistry.holderByNameCodec(), strategy1, holder_c)); // CraftBukkit - read/write
    }
