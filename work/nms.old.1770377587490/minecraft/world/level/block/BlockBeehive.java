...
public class BlockBeehive extends BlockTileEntity {
    ...
    public static void dropHoneycomb(WorldServer worldserver, ItemStack itemstack, IBlockData iblockdata, @Nullable TileEntity tileentity, @Nullable Entity entity, BlockPosition blockposition) {
        dropFromBlockInteractLootTable(worldserver, LootTables.HARVEST_BEEHIVE, iblockdata, tileentity, itemstack, entity, (worldserver1, itemstack1) -> {
            popResource(worldserver1, blockposition, itemstack1);
        });
    }
            ...
            label40:
            {
                ...
                if (world instanceof WorldServer) {
                    ...
                    if (itemstack.is(Items.SHEARS)) {
                        dropHoneycomb(worldserver, itemstack, iblockdata, world.getBlockEntity(blockposition), entityhuman, blockposition);
                        world.playSound((Entity) null, entityhuman.getX(), entityhuman.getY(), entityhuman.getZ(), SoundEffects.BEEHIVE_SHEAR, SoundCategory.BLOCKS, 1.0F, 1.0F);
