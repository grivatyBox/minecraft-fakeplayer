...
public final class TrialSpawner {
    ...
    public boolean canSpawnInLevel(WorldServer worldserver) {
        return !worldserver.getServer().getGameRules().getBoolean(GameRules.RULE_SPAWNER_BLOCKS_ENABLED) ? false : (this.overridePeacefulAndMobSpawnRule ? true : (worldserver.getDifficulty() == EnumDifficulty.PEACEFUL ? false : worldserver.getGameRules().getBoolean(GameRules.RULE_DOMOBSPAWNING)));
    }
