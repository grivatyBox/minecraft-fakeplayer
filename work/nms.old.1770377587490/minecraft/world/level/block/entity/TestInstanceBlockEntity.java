...
public class TestInstanceBlockEntity extends TileEntity implements BeaconBeamOwner, BoundingBoxRenderable {
    ...
    private final List<TestInstanceBlockEntity.b> errorMarkers = new ArrayList();
    ...
    public TestInstanceBlockEntity(BlockPosition blockposition, IBlockData iblockdata) {
        ...
        this.data = new TestInstanceBlockEntity.a(Optional.empty(), BaseBlockPosition.ZERO, EnumBlockRotation.NONE, false, TestInstanceBlockEntity.c.CLEARED, Optional.empty());
    }
    ...
    public void setSuccess() {
        this.set(this.data.withStatus(TestInstanceBlockEntity.c.FINISHED));
    }

    public void setRunning() {
        this.set(this.data.withStatus(TestInstanceBlockEntity.c.RUNNING));
    }
    ...
    protected void loadAdditional(ValueInput valueinput) {
        valueinput.read("data", TestInstanceBlockEntity.a.CODEC).ifPresent(this::set);
        this.errorMarkers.clear();
        this.errorMarkers.addAll((Collection) valueinput.read("errors", TestInstanceBlockEntity.b.LIST_CODEC).orElse(List.of()));
    }

    @Override
    protected void saveAdditional(ValueOutput valueoutput) {
        valueoutput.store("data", TestInstanceBlockEntity.a.CODEC, this.data);
        if (!this.errorMarkers.isEmpty()) {
            valueoutput.store("errors", TestInstanceBlockEntity.b.LIST_CODEC, this.errorMarkers);
        }
    ...
    public void resetTest(Consumer<IChatBaseComponent> consumer) {
        ...
        this.set(this.data.withStatus(TestInstanceBlockEntity.c.CLEARED));
    }
    ...
    public Optional<MinecraftKey> saveTest(Consumer<IChatBaseComponent> consumer) {
        ...
        if (optional1.isEmpty()) {
            ...
            if (world instanceof WorldServer) {
                ...
                TileEntityStructure.saveStructure(worldserver, (MinecraftKey) optional1.get(), this.getStructurePos(), this.getSize(), this.ignoreEntities(), "", true, List.of(Blocks.AIR));
            }
    ...
    private void placeStructure(WorldServer worldserver, DefinedStructure definedstructure) {
        ...
        GameTestHarnessStructures.clearSpaceForStructure(this.getStructureBoundingBox(), worldserver);
        this.removeEntities();
    ...
    public void markError(BlockPosition blockposition, IChatBaseComponent ichatbasecomponent) {
        this.errorMarkers.add(new TestInstanceBlockEntity.b(blockposition, ichatbasecomponent));
        this.setChanged();
    }
    ...
    public List<TestInstanceBlockEntity.b> getErrorMarkers() {
    ...
    public static enum c implements INamable {
        ...
        private static final IntFunction<TestInstanceBlockEntity.c> ID_MAP = ByIdMap.<TestInstanceBlockEntity.c>continuous((testinstanceblockentity_c) -> {
            return testinstanceblockentity_c.index;
        }, values(), ByIdMap.a.ZERO);
        public static final Codec<TestInstanceBlockEntity.c> CODEC = INamable.<TestInstanceBlockEntity.c>fromEnum(TestInstanceBlockEntity.c::values);
        public static final StreamCodec<ByteBuf, TestInstanceBlockEntity.c> STREAM_CODEC = ByteBufCodecs.idMapper(TestInstanceBlockEntity.c::byIndex, (testinstanceblockentity_c) -> {
            return testinstanceblockentity_c.index;
        });
        private final String id;
        private final int index;

        private c(final String s, final int i) {
            this.id = s;
            this.index = i;
        }
    ...
    public static record a(Optional<ResourceKey<GameTestInstance>> test, BaseBlockPosition size, EnumBlockRotation rotation, boolean ignoreEntities, TestInstanceBlockEntity.c status, Optional<IChatBaseComponent> errorMessage) {
        ...
        public TestInstanceBlockEntity.a withStatus(TestInstanceBlockEntity.c testinstanceblockentity_c) {
            return new TestInstanceBlockEntity.a(this.test, this.size, this.rotation, this.ignoreEntities, testinstanceblockentity_c, Optional.empty());
        }

        public TestInstanceBlockEntity.a withError(IChatBaseComponent ichatbasecomponent) {
            return new TestInstanceBlockEntity.a(this.test, this.size, this.rotation, this.ignoreEntities, TestInstanceBlockEntity.c.FINISHED, Optional.of(ichatbasecomponent));
        }
    }

    public static record b(BlockPosition pos, IChatBaseComponent text) {

        public static final Codec<TestInstanceBlockEntity.b> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(BlockPosition.CODEC.fieldOf("pos").forGetter(TestInstanceBlockEntity.b::pos), ComponentSerialization.CODEC.fieldOf("text").forGetter(TestInstanceBlockEntity.b::text)).apply(instance, TestInstanceBlockEntity.b::new);
        });
        public static final Codec<List<TestInstanceBlockEntity.b>> LIST_CODEC = TestInstanceBlockEntity.b.CODEC.listOf();
    }
}
