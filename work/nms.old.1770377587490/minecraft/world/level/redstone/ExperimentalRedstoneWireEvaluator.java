...
public class ExperimentalRedstoneWireEvaluator extends RedstoneWireEvaluator {
    ...
    private void causeNeighborUpdates(World world) {
        ...
        if (world instanceof WorldServer worldserver) {
            if (worldserver.debugSynchronizers().hasAnySubscriberFor(DebugSubscriptions.REDSTONE_WIRE_ORIENTATIONS)) {
                this.updatedWires.forEach((blockposition, integer) -> {
                    worldserver.debugSynchronizers().sendBlockValue(blockposition, DebugSubscriptions.REDSTONE_WIRE_ORIENTATIONS, unpackOrientation(integer));
                });
            }
        }
