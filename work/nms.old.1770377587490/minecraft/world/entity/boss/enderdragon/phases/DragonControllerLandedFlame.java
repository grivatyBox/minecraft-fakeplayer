...
public class DragonControllerLandedFlame extends AbstractDragonControllerLanded {
    ...
    public void doClientTick() {
        ...
        if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int j = 0; j < 6; ++j) {
                    this.dragon.level().addParticle(PowerParticleOption.create(Particles.DRAGON_BREATH, 1.0F), d3, d4, d5, -vec3d.x * (double) 0.08F * (double) j, -vec3d.y * (double) 0.6F, -vec3d.z * (double) 0.08F * (double) j);
                }
    ...
    public void doServerTick(WorldServer worldserver) {
        ...
        if (this.flameTicks >= 200) {
            ...
            this.flame.setCustomParticle(PowerParticleOption.create(Particles.DRAGON_BREATH, 1.0F));
