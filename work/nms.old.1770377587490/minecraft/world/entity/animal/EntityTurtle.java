...
public class EntityTurtle extends EntityAnimal {
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        ...
        valueoutput.store("home_pos", BlockPosition.CODEC, this.homePos);
        valueoutput.putBoolean("has_egg", this.hasEgg());
    }

    @Override
    protected void readAdditionalSaveData(ValueInput valueinput) {
        this.setHomePos((BlockPosition) valueinput.read("home_pos", BlockPosition.CODEC).orElse(this.blockPosition()));
        ...
        if (!this.isBaby()) {
            ...
            if (world instanceof WorldServer) {
                ...
                if (worldserver.getGameRules().getBoolean(GameRules.RULE_DOMOBLOOT)) {
                    ...
                    this.dropFromGiftLootTable(worldserver, LootTables.TURTLE_GROW, this::spawnAtLocation);
