...
public class EntityFox extends EntityAnimal {
    ...
    void addTrustedEntity(EntityLiving entityliving) {
        this.addTrustedEntity(EntityReference.of(entityliving));
    }
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        ...
        valueoutput.store("Trusted", EntityFox.TRUSTED_LIST_CODEC, this.getTrustedEntities().toList());
        valueoutput.putBoolean("Sleeping", this.isSleeping());
        valueoutput.store("Type", EntityFox.Type.CODEC, this.getVariant());
        ...
        public boolean canUse() {
            if (this.randomInterval > 0 && this.mob.getRandom().nextInt(this.randomInterval) != 0) {
                ...
                for (EntityReference<EntityLiving> entityreference : EntityFox.this.getTrustedEntities().toList()) {
                    EntityLiving entityliving = (EntityLiving) entityreference.getEntity(worldserver, EntityLiving.class);
