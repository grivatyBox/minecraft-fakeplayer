...
public class EntityZombieVillager extends EntityZombie implements VillagerDataHolder {
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntityZombieVillager.DATA_VILLAGER_DATA, this.initializeVillagerData());
    }
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        ...
        valueoutput.storeNullable("Offers", MerchantRecipeList.CODEC, this.tradeOffers);
        valueoutput.storeNullable("Gossips", Reputation.CODEC, this.gossips);
    ...
    protected void readAdditionalSaveData(ValueInput valueinput) {
        ...
        this.entityData.set(EntityZombieVillager.DATA_VILLAGER_DATA, (VillagerData) valueinput.read("VillagerData", VillagerData.CODEC).orElseGet(this::initializeVillagerData));
    ...
    private VillagerData initializeVillagerData() {
        ...
        Optional<Holder.c<VillagerProfession>> optional = BuiltInRegistries.VILLAGER_PROFESSION.getRandom(this.random);
        VillagerData villagerdata = EntityVillager.createDefaultVillagerData().withType(world.registryAccess(), VillagerType.byBiome(world.getBiome(this.blockPosition())));
