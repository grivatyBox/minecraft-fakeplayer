...
public class PersistentRaid extends PersistentBase {
    ...
    @VisibleForDebug
    public List<BlockPosition> getRaidCentersInChunk(ChunkCoordIntPair chunkcoordintpair) {
        Stream<BlockPosition> stream = this.raidMap.values().stream().map(Raid::getCenter); // CraftBukkit - decompile error
