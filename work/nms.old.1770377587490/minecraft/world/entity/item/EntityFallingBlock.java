...
public class EntityFallingBlock extends Entity {
                            ...
                            if (!this.cancelDrop) {
                                ...
                                if (flag2 && flag4) {
                                    ...
                                    if (this.level().setBlock(blockposition, this.blockState, 3)) {
                                        worldserver.getChunkSource().chunkMap.sendToTrackingPlayers(this, new PacketPlayOutBlockChange(blockposition, this.level().getBlockState(blockposition)));
                                        this.discard(EntityRemoveEvent.Cause.DESPAWN); // CraftBukkit - add Bukkit remove cause
                                        ...
                                        if (this.blockData != null && this.blockState.hasBlockEntity()) {
                                            ...
                                            if (tileentity != null) {
                                                try (ProblemReporter.j problemreporter_j = new ProblemReporter.j(tileentity.problemPath(), EntityFallingBlock.LOGGER)) {
                                                    ...
                                                    tileentity.loadWithComponents(TagValueInput.create(problemreporter_j, iregistrycustom, nbttagcompound));
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        valueoutput.store("BlockState", IBlockData.CODEC, this.blockState);
        ...
        if (this.blockData != null) {
            valueoutput.store("TileEntityData", NBTTagCompound.CODEC, this.blockData);
        }
    ...
    protected void readAdditionalSaveData(ValueInput valueinput) {
        this.blockState = (IBlockData) valueinput.read("BlockState", IBlockData.CODEC).orElse(EntityFallingBlock.DEFAULT_BLOCK_STATE);
