...
public class TicketStorage extends PersistentBase {
    ...
    public void purgeStaleTickets(PlayerChunkMap playerchunkmap) {
        this.removeTicketIf((olong, ticket) -> {
            PlayerChunk playerchunk = playerchunkmap.getUpdatingChunkIfPresent(olong);
            boolean flag = playerchunk != null && !playerchunk.isReadyForSaving() && ticket.getType().doesSimulate();
