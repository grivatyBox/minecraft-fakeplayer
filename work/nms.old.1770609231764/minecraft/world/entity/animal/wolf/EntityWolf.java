...
public class EntityWolf extends EntityTameableAnimal implements IEntityAngerable {
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        ...
        this.getSoundVariant().unwrapKey().ifPresent((resourcekey) -> {
            valueoutput.store("sound_variant", ResourceKey.codec(Registries.WOLF_SOUND_VARIANT), resourcekey);
        });
    }
    ...
    protected void readAdditionalSaveData(ValueInput valueinput) {
        ...
        this.setCollarColor((EnumColor) valueinput.read("CollarColor", EnumColor.LEGACY_ID_CODEC).orElse(EntityWolf.DEFAULT_COLLAR_COLOR));
        this.readPersistentAngerSaveData(this.level(), valueinput);
        valueinput.read("sound_variant", ResourceKey.codec(Registries.WOLF_SOUND_VARIANT)).flatMap((resourcekey) -> {
    ...
    public GroupDataEntity finalizeSpawn(WorldAccess worldaccess, DifficultyDamageScaler difficultydamagescaler, EntitySpawnReason entityspawnreason, @Nullable GroupDataEntity groupdataentity) {
        if (groupdataentity instanceof EntityWolf.b entitywolf_b) {
            ...
            Optional<? extends Holder<WolfVariant>> optional = VariantUtils.selectVariantToSpawn(SpawnContext.create(worldaccess, this.blockPosition()), Registries.WOLF_VARIANT);
        ...
        this.setSoundVariant(WolfSoundVariants.pickRandomSoundVariant(this.registryAccess(), worldaccess.getRandom()));
    ...
    protected boolean canShearEquipment(EntityHuman entityhuman) {
        return this.isOwnedBy(entityhuman);
    }
