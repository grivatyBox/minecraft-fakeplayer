...
public abstract class EntityMinecartAbstract extends VehicleEntity {
    ...
    public void recreateFromPacket(PacketPlayOutSpawnEntity packetplayoutspawnentity) {
        ...
        this.behavior.lerpMotion(vec3d.x, vec3d.y, vec3d.z);
    }
    ...
    protected void readAdditionalSaveData(ValueInput valueinput) {
        this.setCustomDisplayBlockState(valueinput.read("DisplayState", IBlockData.CODEC));
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        this.getCustomDisplayBlockState().ifPresent((iblockdata) -> {
            valueoutput.store("DisplayState", IBlockData.CODEC, iblockdata);
        });
