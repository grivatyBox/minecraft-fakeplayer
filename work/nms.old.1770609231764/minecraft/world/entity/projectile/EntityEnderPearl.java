...
public class EntityEnderPearl extends EntityProjectileThrowable {
    ...
    public Entity getOwner() {
        if (this.owner != null) {
            ...
            if (world instanceof WorldServer) {
                ...
                return this.owner.getEntity((uuid) -> {
                    return findOwnerInAnyDimension(worldserver, uuid);
                }, Entity.class);
            }
        }
    ...
    @Nullable
    private static Entity findOwnerInAnyDimension(WorldServer worldserver, UUID uuid) {
