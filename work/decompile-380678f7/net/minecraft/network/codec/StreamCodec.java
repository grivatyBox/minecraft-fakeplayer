...
public interface StreamCodec<B, V> extends StreamDecoder<B, V>, StreamEncoder<B, V> {
    ...
    static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> StreamCodec<B, C> composite(final StreamCodec<? super B, T1> streamcodec, final Function<C, T1> function, final StreamCodec<? super B, T2> streamcodec1, final Function<C, T2> function1, final StreamCodec<? super B, T3> streamcodec2, final Function<C, T3> function2, final StreamCodec<? super B, T4> streamcodec3, final Function<C, T4> function3, final StreamCodec<? super B, T5> streamcodec4, final Function<C, T5> function4, final StreamCodec<? super B, T6> streamcodec5, final Function<C, T6> function5, final StreamCodec<? super B, T7> streamcodec6, final Function<C, T7> function6, final StreamCodec<? super B, T8> streamcodec7, final Function<C, T8> function7, final StreamCodec<? super B, T9> streamcodec8, final Function<C, T9> function8, final StreamCodec<? super B, T10> streamcodec9, final Function<C, T10> function9, final StreamCodec<? super B, T11> streamcodec10, final Function<C, T11> function10, final Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, C> function11) {
        return new StreamCodec<B, C>() {
            @Override
            public C decode(B b0) {
                T1 t1 = (T1) streamcodec.decode(b0);
                ...
                T8 t8 = (T8) streamcodec7.decode(b0);
                T9 t9 = (T9) streamcodec8.decode(b0);
                T10 t10 = (T10) streamcodec9.decode(b0);
                T11 t11 = (T11) streamcodec10.decode(b0);

                return (C) function11.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11);
            }
            ...
            public void encode(B b0, C c0) {
                ...
                streamcodec7.encode(b0, function7.apply(c0));
                streamcodec8.encode(b0, function8.apply(c0));
                streamcodec9.encode(b0, function9.apply(c0));
                streamcodec10.encode(b0, function10.apply(c0));
            }
        };
    }
