...
public record NBTTagString(String value) implements PrimitiveTag {
    ...
    public static String escapeWithoutQuotes(String s) {
        StringBuilder stringbuilder = new StringBuilder();

        escapeWithoutQuotes(s, stringbuilder);
        return stringbuilder.toString();
    }

    public static void escapeWithoutQuotes(String s, StringBuilder stringbuilder) {
