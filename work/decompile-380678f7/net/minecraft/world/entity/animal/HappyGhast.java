...
public class HappyGhast extends EntityAnimal {
    ...
    private boolean scanPlayerAboveGhast() {
        ...
        AxisAlignedBB axisalignedbb1 = new AxisAlignedBB(axisalignedbb.minX - 1.0D, axisalignedbb.maxY, axisalignedbb.minZ - 1.0D, axisalignedbb.maxX + 1.0D, axisalignedbb.maxY + axisalignedbb.getYsize() / 2.0D, axisalignedbb.maxZ + 1.0D);
