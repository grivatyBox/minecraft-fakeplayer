...
public class AttributeModifiable {
    ...
    public AttributeModifiable.a pack() {
        return new AttributeModifiable.a(this.attribute, this.baseValue, List.copyOf(this.permanentModifiers.values()));
    }

    public void apply(AttributeModifiable.a attributemodifiable_a) {
        this.baseValue = attributemodifiable_a.baseValue;

        for (AttributeModifier attributemodifier : attributemodifiable_a.modifiers) {
    ...
    public static record a(Holder<AttributeBase> attribute, double baseValue, List<AttributeModifier> modifiers) {

        public static final Codec<AttributeModifiable.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(BuiltInRegistries.ATTRIBUTE.holderByNameCodec().fieldOf("id").forGetter(AttributeModifiable.a::attribute), Codec.DOUBLE.fieldOf("base").orElse(0.0D).forGetter(AttributeModifiable.a::baseValue), AttributeModifier.CODEC.listOf().optionalFieldOf("modifiers", List.of()).forGetter(AttributeModifiable.a::modifiers)).apply(instance, AttributeModifiable.a::new);
        });
        public static final Codec<List<AttributeModifiable.a>> LIST_CODEC = AttributeModifiable.a.CODEC.listOf();
    }
}
