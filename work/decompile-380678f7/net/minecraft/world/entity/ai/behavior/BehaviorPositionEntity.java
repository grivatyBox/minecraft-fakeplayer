...
public class BehaviorPositionEntity implements BehaviorPosition {
    ...
    public BehaviorPositionEntity(Entity entity, boolean flag) {
        this(entity, flag, false);
    }

    public BehaviorPositionEntity(Entity entity, boolean flag, boolean flag1) {
        this.entity = entity;
        this.trackEyeHeight = flag;
        this.targetEyeHeight = flag1;
    }
    ...
    public BlockPosition currentBlockPosition() {
        return this.targetEyeHeight ? BlockPosition.containing(this.entity.getEyePosition()) : this.entity.blockPosition();
    }
