...
public class ChatDeserializer {
    ...
    public static <T> T fromJson(Gson gson, Reader reader, Class<T> oclass) {
        try {
            ...
            T t0 = (T) gson.getAdapter(oclass).read(jsonreader);
    ...
    public static <T> T fromJson(Gson gson, Reader reader, TypeToken<T> typetoken) {
        T t0 = (T) fromNullableJson(gson, reader, typetoken);
    ...
    public static <T> T fromNullableJson(Gson gson, String s, TypeToken<T> typetoken) {
        return (T) fromNullableJson(gson, (Reader) (new StringReader(s)), typetoken);
    }

    public static <T> T fromJson(Gson gson, String s, Class<T> oclass) {
        return (T) fromJson(gson, (Reader) (new StringReader(s)), oclass);
    }
    ...
    public static JsonObject parse(Reader reader) {
        return (JsonObject) fromJson(ChatDeserializer.GSON, reader, JsonObject.class);
    }
    ...
    public static JsonArray parseArray(Reader reader) {
        return (JsonArray) fromJson(ChatDeserializer.GSON, reader, JsonArray.class);
    }
