...
public class TileEntityPiston extends TileEntity {
    ...
    protected void loadAdditional(ValueInput valueinput) {
        ...
        this.movedState = (IBlockData) valueinput.read("blockState", IBlockData.CODEC).orElse(TileEntityPiston.DEFAULT_BLOCK_STATE);
        this.direction = (EnumDirection) valueinput.read("facing", EnumDirection.LEGACY_ID_CODEC).orElse(EnumDirection.DOWN);
    ...
    protected void saveAdditional(ValueOutput valueoutput) {
        ...
        valueoutput.store("blockState", IBlockData.CODEC, this.movedState);
        valueoutput.store("facing", EnumDirection.LEGACY_ID_CODEC, this.direction);
