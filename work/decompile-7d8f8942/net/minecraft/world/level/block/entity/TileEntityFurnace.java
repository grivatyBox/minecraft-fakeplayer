...
public abstract class TileEntityFurnace extends TileEntityContainer implements IWorldInventory, RecipeCraftingHolder, AutoRecipeOutput {
    ...
    protected void loadAdditional(ValueInput valueinput) {
        ...
        this.recipesUsed.putAll((Map) valueinput.read("RecipesUsed", TileEntityFurnace.RECIPES_USED_CODEC).orElse(Map.of()));
    }
    ...
    protected void saveAdditional(ValueOutput valueoutput) {
        ...
        valueoutput.store("RecipesUsed", TileEntityFurnace.RECIPES_USED_CODEC, this.recipesUsed);
    }
