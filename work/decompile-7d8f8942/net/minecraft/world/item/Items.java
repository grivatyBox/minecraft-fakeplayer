...
public class Items {
    ...
    public static final Item HAPPY_GHAST_SPAWN_EGG = registerItem("happy_ghast_spawn_egg", (item_info) -> {
        return new ItemMonsterEgg(EntityTypes.HAPPY_GHAST, item_info);
    });
