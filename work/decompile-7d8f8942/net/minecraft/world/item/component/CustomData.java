...
public final class CustomData {
    ...
    public void loadInto(Entity entity) {
        try (ProblemReporter.j problemreporter_j = new ProblemReporter.j(entity.problemPath(), CustomData.LOGGER)) {
    ...
    public boolean loadInto(TileEntity tileentity, HolderLookup.a holderlookup_a) {
        try (ProblemReporter.j problemreporter_j = new ProblemReporter.j(tileentity.problemPath(), CustomData.LOGGER)) {
