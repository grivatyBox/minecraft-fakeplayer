...
public interface EquipmentAssets {
    ...
    Map<EnumColor, ResourceKey<EquipmentAsset>> HARNESSES = SystemUtils.<EnumColor, ResourceKey<EquipmentAsset>>makeEnumMap(EnumColor.class, (enumcolor) -> {
        return createId(enumcolor.getSerializedName() + "_harness");
    });
