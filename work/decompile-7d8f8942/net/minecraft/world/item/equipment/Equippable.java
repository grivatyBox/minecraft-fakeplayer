...
public record Equippable(EnumItemSlot slot, Holder<SoundEffect> equipSound, Optional<ResourceKey<EquipmentAsset>> assetId, Optional<MinecraftKey> cameraOverlay, Optional<HolderSet<EntityTypes<?>>> allowedEntities, boolean dispensable, boolean swappable, boolean damageOnHurt, boolean equipOnInteract, boolean canBeSheared, Holder<SoundEffect> shearingSound) {
    ...
    public static final Codec<Equippable> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(EnumItemSlot.CODEC.fieldOf("slot").forGetter(Equippable::slot), SoundEffect.CODEC.optionalFieldOf("equip_sound", SoundEffects.ARMOR_EQUIP_GENERIC).forGetter(Equippable::equipSound), ResourceKey.codec(EquipmentAssets.ROOT_ID).optionalFieldOf("asset_id").forGetter(Equippable::assetId), MinecraftKey.CODEC.optionalFieldOf("camera_overlay").forGetter(Equippable::cameraOverlay), RegistryCodecs.homogeneousList(Registries.ENTITY_TYPE).optionalFieldOf("allowed_entities").forGetter(Equippable::allowedEntities), Codec.BOOL.optionalFieldOf("dispensable", true).forGetter(Equippable::dispensable), Codec.BOOL.optionalFieldOf("swappable", true).forGetter(Equippable::swappable), Codec.BOOL.optionalFieldOf("damage_on_hurt", true).forGetter(Equippable::damageOnHurt), Codec.BOOL.optionalFieldOf("equip_on_interact", false).forGetter(Equippable::equipOnInteract), Codec.BOOL.optionalFieldOf("can_be_sheared", false).forGetter(Equippable::canBeSheared), SoundEffect.CODEC.optionalFieldOf("shearing_sound", BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEffects.SHEARS_SNIP)).forGetter(Equippable::shearingSound)).apply(instance, Equippable::new);
    });
    ...
    public static Equippable llamaSwag(EnumColor enumcolor) {
        return builder(EnumItemSlot.BODY).setEquipSound(SoundEffects.LLAMA_SWAG).setAsset((ResourceKey) EquipmentAssets.CARPETS.get(enumcolor)).setAllowedEntities(EntityTypes.LLAMA, EntityTypes.TRADER_LLAMA).setCanBeSheared(true).setShearingSound(SoundEffects.LLAMA_CARPET_UNEQUIP).build();
    }
    ...
    public static Equippable saddle() {
        ...
        return builder(EnumItemSlot.SADDLE).setEquipSound(SoundEffects.HORSE_SADDLE).setAsset(EquipmentAssets.SADDLE).setAllowedEntities(holdergetter.getOrThrow(TagsEntity.CAN_EQUIP_SADDLE)).setEquipOnInteract(true).setCanBeSheared(true).setShearingSound(SoundEffects.SADDLE_UNEQUIP).build();
    }

    public static Equippable harness(EnumColor enumcolor) {
        HolderGetter<EntityTypes<?>> holdergetter = BuiltInRegistries.<EntityTypes<?>>acquireBootstrapRegistrationLookup(BuiltInRegistries.ENTITY_TYPE);

        return builder(EnumItemSlot.BODY).setEquipSound(SoundEffects.HARNESS_EQUIP).setAsset((ResourceKey) EquipmentAssets.HARNESSES.get(enumcolor)).setAllowedEntities(holdergetter.getOrThrow(TagsEntity.CAN_EQUIP_HARNESS)).setEquipOnInteract(true).setCanBeSheared(true).setShearingSound(BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEffects.HARNESS_UNEQUIP)).build();
    }
    ...
    public static class a {
        ...
        private Holder<SoundEffect> shearingSound;
        ...
        a(EnumItemSlot enumitemslot) {
            ...
            this.shearingSound = BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEffects.SHEARS_SNIP);
        ...
        public Equippable.a setCanBeSheared(boolean flag) {
            this.canBeSheared = flag;
            return this;
        }

        public Equippable.a setShearingSound(Holder<SoundEffect> holder) {
