...
public class EntityTropicalFish extends EntityFishSchool {
    ...
    protected void addAdditionalSaveData(ValueOutput valueoutput) {
        ...
        valueoutput.store("Variant", EntityTropicalFish.d.CODEC, new EntityTropicalFish.d(this.getPackedVariant()));
    }

    @Override
    protected void readAdditionalSaveData(ValueInput valueinput) {
        super.readAdditionalSaveData(valueinput);
        EntityTropicalFish.d entitytropicalfish_d = (EntityTropicalFish.d) valueinput.read("Variant", EntityTropicalFish.d.CODEC).orElse(EntityTropicalFish.DEFAULT_VARIANT);
