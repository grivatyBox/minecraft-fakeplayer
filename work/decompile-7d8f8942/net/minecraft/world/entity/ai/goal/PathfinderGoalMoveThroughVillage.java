                ...
                if (!worldserver.isCloseToVillage(blockposition, 6)) {
                    ...
                    if (vec3d == null) {
                        ...
                        if (optional.isEmpty()) {
                            ...
                            navigationabstract.setCanOpenDoors(this.canDealWithDoors.getAsBoolean());
                            this.path = navigationabstract.createPath(this.poiPos, 0);
                            navigationabstract.setCanOpenDoors(true);
                            if (this.path == null) {
