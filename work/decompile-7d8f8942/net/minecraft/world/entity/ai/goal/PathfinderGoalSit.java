...
public class PathfinderGoalSit extends PathfinderGoal {
    ...
    public boolean canUse() {
        ...
        if (!flag && !this.mob.isTame()) {
            ...
            return entityliving != null && entityliving.level() == this.mob.level() ? (this.mob.distanceToSqr((Entity) entityliving) < 144.0D && entityliving.getLastHurtByMob() != null ? false : flag) : true;
        }
    }
