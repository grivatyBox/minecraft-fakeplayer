...
public final class ProjectileHelper {
    ...
    public static MovingObjectPosition getHitResultOnMoveVector(Entity entity, Predicate<Entity> predicate) {
        ...
        return getHitResult(vec3d1, entity, predicate, vec3d, world, computeMargin(entity), RayTrace.BlockCollisionOption.COLLIDER);
    }
    ...
    public static MovingObjectPosition getHitResultOnMoveVector(Entity entity, Predicate<Entity> predicate, RayTrace.BlockCollisionOption raytrace_blockcollisionoption) {
        ...
        return getHitResult(vec3d1, entity, predicate, vec3d, world, computeMargin(entity), raytrace_blockcollisionoption);
    }
    ...
    @Nullable
    public static MovingObjectPositionEntity getEntityHitResult(World world, IProjectile iprojectile, Vec3D vec3d, Vec3D vec3d1, AxisAlignedBB axisalignedbb, Predicate<Entity> predicate) {
        return getEntityHitResult(world, iprojectile, vec3d, vec3d1, axisalignedbb, predicate, computeMargin(iprojectile));
    }
