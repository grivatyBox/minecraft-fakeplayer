...
public interface ContainerEntity extends IInventory, ITileInventory {
    ...
    default void addChestVehicleSaveData(ValueOutput valueoutput) {
        if (this.getContainerLootTable() != null) {
            ...
            ContainerUtil.saveAllItems(valueoutput, this.getItemStacks());
        }
    ...
    default void readChestVehicleSaveData(ValueInput valueinput) {
        ...
        ResourceKey<LootTable> resourcekey = (ResourceKey) valueinput.read("LootTable", LootTable.KEY_CODEC).orElse((Object) null);

        this.setContainerLootTable(resourcekey);
        this.setContainerLootTableSeed(valueinput.getLongOr("LootTableSeed", 0L));
        if (resourcekey == null) {
            ContainerUtil.loadAllItems(valueinput, this.getItemStacks());
        }
