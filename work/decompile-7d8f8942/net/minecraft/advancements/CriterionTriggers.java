...
public class CriterionTriggers {
    ...
    public static final CriterionTriggerPlayerInteractedWithEntity PLAYER_SHEARED_EQUIPMENT = (CriterionTriggerPlayerInteractedWithEntity) register("player_sheared_equipment", new CriterionTriggerPlayerInteractedWithEntity());
