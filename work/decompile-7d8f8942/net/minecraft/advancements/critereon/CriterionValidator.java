...
public class CriterionValidator {
    ...
    public void validate(ContextAwarePredicate contextawarepredicate, ContextKeySet contextkeyset, String s) {
        contextawarepredicate.validate(new LootCollector(this.reporter.forChild(new ProblemReporter.c(s)), contextkeyset, this.lootData));
    }
    ...
    public void validate(List<ContextAwarePredicate> list, ContextKeySet contextkeyset, String s) {
        for (int i = 0; i < list.size(); ++i) {
            ...
            contextawarepredicate.validate(new LootCollector(this.reporter.forChild(new ProblemReporter.d(s, i)), contextkeyset, this.lootData));
        }
