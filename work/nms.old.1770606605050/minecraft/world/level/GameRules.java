...
public class GameRules {
    ...
    public static final GameRules.GameRuleKey<GameRules.GameRuleBoolean> RULE_DAYLIGHT = register("doDaylightCycle", GameRules.GameRuleCategory.UPDATES, GameRules.GameRuleBoolean.create(!SharedConstants.DEBUG_WORLD_RECREATE));
    ...
    public static final GameRules.GameRuleKey<GameRules.GameRuleBoolean> RULE_WEATHER_CYCLE = register("doWeatherCycle", GameRules.GameRuleCategory.UPDATES, GameRules.GameRuleBoolean.create(!SharedConstants.DEBUG_WORLD_RECREATE));
    ...
    public static final GameRules.GameRuleKey<GameRules.GameRuleBoolean> RULE_PVP = register("pvp", GameRules.GameRuleCategory.PLAYER, GameRules.GameRuleBoolean.create(true));
    public static final GameRules.GameRuleKey<GameRules.GameRuleBoolean> RULE_ALLOW_NETHER = register("allowEnteringNetherUsingPortals", GameRules.GameRuleCategory.MISC, GameRules.GameRuleBoolean.create(true));
    public static final GameRules.GameRuleKey<GameRules.GameRuleBoolean> RULE_SPAWN_MONSTERS = register("spawnMonsters", GameRules.GameRuleCategory.SPAWNING, GameRules.GameRuleBoolean.create(true, (minecraftserver, gamerules_gameruleboolean) -> {
        minecraftserver.setSpawnSettings(MinecraftServer.isSpawningMonsters(minecraftserver)); // CraftBukkit
    }));
    public static final GameRules.GameRuleKey<GameRules.GameRuleBoolean> RULE_COMMAND_BLOCKS_ENABLED = register("commandBlocksEnabled", GameRules.GameRuleCategory.MISC, GameRules.GameRuleBoolean.create(true));
    public static final GameRules.GameRuleKey<GameRules.GameRuleBoolean> RULE_SPAWNER_BLOCKS_ENABLED = register("spawnerBlocksEnabled", GameRules.GameRuleCategory.MISC, GameRules.GameRuleBoolean.create(true));
    ...
    public static Stream<Map.Entry<GameRules.GameRuleKey<?>, GameRules.GameRuleDefinition<?>>> availableRules(FeatureFlagSet featureflagset) {
    ...
    public GameRules copy(FeatureFlagSet featureflagset) {
        return new GameRules((Map) availableRules(featureflagset).collect(ImmutableMap.toImmutableMap(Entry::getKey, (entry) -> {
            return this.rules.containsKey(entry.getKey()) ? ((GameRules.GameRuleValue) this.rules.get(entry.getKey())).copy() : ((GameRules.GameRuleDefinition) entry.getValue()).createRule();
        })), featureflagset);
    }
    ...
    public static class GameRuleInt extends GameRules.GameRuleValue<GameRules.GameRuleInt> {
        ...
        public static GameRules.GameRuleDefinition<GameRules.GameRuleInt> create(int i) {
    ...
    public static class GameRuleBoolean extends GameRules.GameRuleValue<GameRules.GameRuleBoolean> {
        ...
        public static GameRules.GameRuleDefinition<GameRules.GameRuleBoolean> create(boolean flag) {
