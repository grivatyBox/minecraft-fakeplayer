...
public class GameEventDispatcher {
    ...
    public void post(Holder<GameEvent> holder, Vec3D vec3d, GameEvent.a gameevent_a) {
        ...
        if (flag) {
            this.level.debugSynchronizers().broadcastEventToTracking(BlockPosition.containing(vec3d), DebugSubscriptions.GAME_EVENTS, new DebugGameEventInfo(holder, vec3d));
        }
