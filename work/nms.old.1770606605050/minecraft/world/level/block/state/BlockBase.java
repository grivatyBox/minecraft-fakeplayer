...
public abstract class BlockBase implements FeatureElement {
    ...
    protected boolean shouldChangedStateKeepBlockEntity(IBlockData iblockdata) {
        return false;
    }
    ...
    public static class Info {
        ...
        public BlockBase.Info noCollision() {
    ...
    public abstract static class BlockData extends IBlockDataHolder<Block, IBlockData> {
        ...
        public int getAnalogOutputSignal(World world, BlockPosition blockposition, EnumDirection enumdirection) {
        ...
        public void entityInside(World world, BlockPosition blockposition, Entity entity, InsideBlockEffectApplier insideblockeffectapplier, boolean flag) {
