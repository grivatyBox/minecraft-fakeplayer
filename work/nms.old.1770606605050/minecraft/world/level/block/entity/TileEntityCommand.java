...
public class TileEntityCommand extends TileEntity {
    ...
    private final CommandBlockListenerAbstract commandBlock = new CommandBlockListenerAbstract() {
        ...
        public CommandListenerWrapper createCommandSourceStack(ICommandListener icommandlistener) {
            ...
            return new CommandListenerWrapper(icommandlistener, Vec3D.atCenterOf(TileEntityCommand.this.worldPosition), new Vec2F(0.0F, enumdirection.toYRot()), this.getLevel(), 2, this.getName().getString(), this.getName(), this.getLevel().getServer(), (Entity) null);
        }
