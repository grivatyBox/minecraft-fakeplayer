...
public class EntityMinecartCommandBlock extends EntityMinecartAbstract {
    ...
    public class a extends CommandBlockListenerAbstract {
        ...
        @Override
        public CommandListenerWrapper createCommandSourceStack(ICommandListener icommandlistener) {
            return new CommandListenerWrapper(icommandlistener, EntityMinecartCommandBlock.this.position(), EntityMinecartCommandBlock.this.getRotationVector(), this.getLevel(), 2, this.getName().getString(), EntityMinecartCommandBlock.this.getDisplayName(), this.getLevel().getServer(), EntityMinecartCommandBlock.this);
        }
