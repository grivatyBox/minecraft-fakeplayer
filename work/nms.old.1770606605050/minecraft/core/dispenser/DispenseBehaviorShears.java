...
public class DispenseBehaviorShears extends DispenseBehaviorMaybe {
    ...
    protected ItemStack execute(SourceBlock sourceblock, ItemStack itemstack) {
        ...
        if (!worldserver.isClientSide()) {
            ...
            this.setSuccess(tryShearBeehive(worldserver, itemstack, blockposition) || tryShearEntity(worldserver, blockposition, itemstack, bukkitBlock, craftItem)); // CraftBukkit
            if (this.isSuccess()) {
    ...
    private static boolean tryShearBeehive(WorldServer worldserver, ItemStack itemstack, BlockPosition blockposition) {
        ...
        if (iblockdata.is(TagsBlock.BEEHIVES, (blockbase_blockdata) -> {
            ...
            if (i >= 5) {
                ...
                BlockBeehive.dropHoneycomb(worldserver, itemstack, iblockdata, worldserver.getBlockEntity(blockposition), (Entity) null, blockposition);
