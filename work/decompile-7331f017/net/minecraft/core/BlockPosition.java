...
public class BlockPosition extends BaseBlockPosition {
    ...
    public static int breadthFirstTraversal(BlockPosition blockposition, int i, int j, BiConsumer<BlockPosition, Consumer<BlockPosition>> biconsumer, Predicate<BlockPosition> predicate) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (longopenhashset.add(i1) && predicate.test(blockposition1)) {
                ++k;
                if (k >= j) {
                    return k;
                }
