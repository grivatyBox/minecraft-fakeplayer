...
public class Items {
    ...
    public static final Item DECORATED_POT = registerBlock(Blocks.DECORATED_POT, (new Item.Info()).component(DataComponents.POT_DECORATIONS, PotDecorations.EMPTY));
    ...
    public static final Item LIGHT = registerBlock(Blocks.LIGHT, (new Item.Info()).rarity(EnumItemRarity.EPIC));
    ...
    public static final Item ELYTRA = registerItem("elytra", (new Item.Info()).durability(432).rarity(EnumItemRarity.EPIC).component(DataComponents.GLIDER, Unit.INSTANCE).component(DataComponents.EQUIPPABLE, Equippable.builder(EnumItemSlot.CHEST).setEquipSound(SoundEffects.ARMOR_EQUIP_ELYTRA).setModel(EquipmentModels.ELYTRA).setDamageOnHurt(false).build()).repairable(Items.PHANTOM_MEMBRANE));
    ...
    }, (new Item.Info()).stacksTo(1).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Item BUNDLE = registerItem("bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("bundle_open_front"), MinecraftKey.withDefaultNamespace("bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item WHITE_BUNDLE = registerItem("white_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("white_bundle_open_front"), MinecraftKey.withDefaultNamespace("white_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item ORANGE_BUNDLE = registerItem("orange_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("orange_bundle_open_front"), MinecraftKey.withDefaultNamespace("orange_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item MAGENTA_BUNDLE = registerItem("magenta_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("magenta_bundle_open_front"), MinecraftKey.withDefaultNamespace("magenta_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item LIGHT_BLUE_BUNDLE = registerItem("light_blue_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("light_blue_bundle_open_front"), MinecraftKey.withDefaultNamespace("light_blue_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item YELLOW_BUNDLE = registerItem("yellow_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("yellow_bundle_open_front"), MinecraftKey.withDefaultNamespace("yellow_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item LIME_BUNDLE = registerItem("lime_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("lime_bundle_open_front"), MinecraftKey.withDefaultNamespace("lime_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item PINK_BUNDLE = registerItem("pink_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("pink_bundle_open_front"), MinecraftKey.withDefaultNamespace("pink_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item GRAY_BUNDLE = registerItem("gray_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("gray_bundle_open_front"), MinecraftKey.withDefaultNamespace("gray_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item LIGHT_GRAY_BUNDLE = registerItem("light_gray_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("light_gray_bundle_open_front"), MinecraftKey.withDefaultNamespace("light_gray_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item CYAN_BUNDLE = registerItem("cyan_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("cyan_bundle_open_front"), MinecraftKey.withDefaultNamespace("cyan_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item PURPLE_BUNDLE = registerItem("purple_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("purple_bundle_open_front"), MinecraftKey.withDefaultNamespace("purple_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item BLUE_BUNDLE = registerItem("blue_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("blue_bundle_open_front"), MinecraftKey.withDefaultNamespace("blue_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item BROWN_BUNDLE = registerItem("brown_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("brown_bundle_open_front"), MinecraftKey.withDefaultNamespace("brown_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item GREEN_BUNDLE = registerItem("green_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("green_bundle_open_front"), MinecraftKey.withDefaultNamespace("green_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item RED_BUNDLE = registerItem("red_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("red_bundle_open_front"), MinecraftKey.withDefaultNamespace("red_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item BLACK_BUNDLE = registerItem("black_bundle", (item_info) -> {
        return new BundleItem(MinecraftKey.withDefaultNamespace("black_bundle_open_front"), MinecraftKey.withDefaultNamespace("black_bundle_open_back"), item_info);
    }, (new Item.Info()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    ...
    public static final Item SPYGLASS = registerItem("spyglass", SpyglassItem::new, (new Item.Info()).stacksTo(1).overrideModel(MinecraftKey.withDefaultNamespace("spyglass_in_hand")));
    ...
    public static final Item TRIDENT = registerItem("trident", ItemTrident::new, (new Item.Info()).rarity(EnumItemRarity.RARE).durability(250).attributes(ItemTrident.createAttributes()).component(DataComponents.TOOL, ItemTrident.createToolProperties()).enchantable(1).overrideModel(MinecraftKey.withDefaultNamespace("trident_in_hand")));
