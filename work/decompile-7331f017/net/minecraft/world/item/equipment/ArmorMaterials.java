...
public interface ArmorMaterials {
    ...
    }), 15, SoundEffects.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, TagsItem.REPAIRS_LEATHER_ARMOR, EquipmentModels.LEATHER);
    ...
    }), 12, SoundEffects.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, TagsItem.REPAIRS_CHAIN_ARMOR, EquipmentModels.CHAINMAIL);
    ...
    }), 9, SoundEffects.ARMOR_EQUIP_IRON, 0.0F, 0.0F, TagsItem.REPAIRS_IRON_ARMOR, EquipmentModels.IRON);
    ...
    }), 25, SoundEffects.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, TagsItem.REPAIRS_GOLD_ARMOR, EquipmentModels.GOLD);
    ...
    }), 10, SoundEffects.ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, TagsItem.REPAIRS_DIAMOND_ARMOR, EquipmentModels.DIAMOND);
    ArmorMaterial TURTLE_SCUTE = new ArmorMaterial(25, (Map) SystemUtils.make(new EnumMap(ArmorType.class), (enummap) -> {
        ...
        enummap.put(ArmorType.HELMET, 2);
        enummap.put(ArmorType.BODY, 5);
    }), 9, SoundEffects.ARMOR_EQUIP_TURTLE, 0.0F, 0.0F, TagsItem.REPAIRS_TURTLE_HELMET, EquipmentModels.TURTLE_SCUTE);
    ArmorMaterial NETHERITE = new ArmorMaterial(37, (Map) SystemUtils.make(new EnumMap(ArmorType.class), (enummap) -> {
        ...
        enummap.put(ArmorType.HELMET, 3);
        enummap.put(ArmorType.BODY, 11);
    }), 15, SoundEffects.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, TagsItem.REPAIRS_NETHERITE_ARMOR, EquipmentModels.NETHERITE);
    ArmorMaterial ARMADILLO_SCUTE = new ArmorMaterial(4, (Map) SystemUtils.make(new EnumMap(ArmorType.class), (enummap) -> {
        ...
        enummap.put(ArmorType.HELMET, 3);
        enummap.put(ArmorType.BODY, 11);
    }), 10, SoundEffects.ARMOR_EQUIP_WOLF, 0.0F, 0.0F, TagsItem.REPAIRS_WOLF_ARMOR, EquipmentModels.ARMADILLO_SCUTE);
}
