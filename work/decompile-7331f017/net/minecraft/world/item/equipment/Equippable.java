...
public record Equippable(EnumItemSlot slot, Holder<SoundEffect> equipSound, Optional<MinecraftKey> model, Optional<MinecraftKey> cameraOverlay, Optional<HolderSet<EntityTypes<?>>> allowedEntities, boolean dispensable, boolean swappable, boolean damageOnHurt) {

    public static final Codec<Equippable> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(EnumItemSlot.CODEC.fieldOf("slot").forGetter(Equippable::slot), SoundEffect.CODEC.optionalFieldOf("equip_sound", SoundEffects.ARMOR_EQUIP_GENERIC).forGetter(Equippable::equipSound), MinecraftKey.CODEC.optionalFieldOf("model").forGetter(Equippable::model), MinecraftKey.CODEC.optionalFieldOf("camera_overlay").forGetter(Equippable::cameraOverlay), RegistryCodecs.homogeneousList(Registries.ENTITY_TYPE).optionalFieldOf("allowed_entities").forGetter(Equippable::allowedEntities), Codec.BOOL.optionalFieldOf("dispensable", true).forGetter(Equippable::dispensable), Codec.BOOL.optionalFieldOf("swappable", true).forGetter(Equippable::swappable), Codec.BOOL.optionalFieldOf("damage_on_hurt", true).forGetter(Equippable::damageOnHurt)).apply(instance, Equippable::new);
    });
    public static final StreamCodec<RegistryFriendlyByteBuf, Equippable> STREAM_CODEC = StreamCodec.composite(EnumItemSlot.STREAM_CODEC, Equippable::slot, SoundEffect.STREAM_CODEC, Equippable::equipSound, MinecraftKey.STREAM_CODEC.apply(ByteBufCodecs::optional), Equippable::model, MinecraftKey.STREAM_CODEC.apply(ByteBufCodecs::optional), Equippable::cameraOverlay, ByteBufCodecs.holderSet(Registries.ENTITY_TYPE).apply(ByteBufCodecs::optional), Equippable::allowedEntities, ByteBufCodecs.BOOL, Equippable::dispensable, ByteBufCodecs.BOOL, Equippable::swappable, ByteBufCodecs.BOOL, Equippable::damageOnHurt, Equippable::new);

    public static Equippable llamaSwag(EnumColor enumcolor) {
        return builder(EnumItemSlot.BODY).setEquipSound(SoundEffects.LLAMA_SWAG).setModel((MinecraftKey) EquipmentModels.CARPETS.get(enumcolor)).setAllowedEntities(EntityTypes.LLAMA, EntityTypes.TRADER_LLAMA).build();
    }
    ...
    public static class a {
        ...
        private Optional<MinecraftKey> model;
        ...
        public Equippable.a setModel(MinecraftKey minecraftkey) {
            this.model = Optional.of(minecraftkey);
            return this;
        }
