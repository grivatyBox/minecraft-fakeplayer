...
public class TrimMaterials {
    ...
    public static void bootstrap(BootstrapContext<TrimMaterial> bootstrapcontext) {
        ...
        register(bootstrapcontext, TrimMaterials.IRON, Items.IRON_INGOT, ChatModifier.EMPTY.withColor(15527148), 0.2F, Map.of(EquipmentModels.IRON, "iron_darker"));
        register(bootstrapcontext, TrimMaterials.NETHERITE, Items.NETHERITE_INGOT, ChatModifier.EMPTY.withColor(6445145), 0.3F, Map.of(EquipmentModels.NETHERITE, "netherite_darker"));
        ...
        register(bootstrapcontext, TrimMaterials.GOLD, Items.GOLD_INGOT, ChatModifier.EMPTY.withColor(14594349), 0.6F, Map.of(EquipmentModels.GOLD, "gold_darker"));
        register(bootstrapcontext, TrimMaterials.EMERALD, Items.EMERALD, ChatModifier.EMPTY.withColor(1155126), 0.7F);
        register(bootstrapcontext, TrimMaterials.DIAMOND, Items.DIAMOND, ChatModifier.EMPTY.withColor(7269586), 0.8F, Map.of(EquipmentModels.DIAMOND, "diamond_darker"));
    ...
    private static void register(BootstrapContext<TrimMaterial> bootstrapcontext, ResourceKey<TrimMaterial> resourcekey, Item item, ChatModifier chatmodifier, float f, Map<MinecraftKey, String> map) {
