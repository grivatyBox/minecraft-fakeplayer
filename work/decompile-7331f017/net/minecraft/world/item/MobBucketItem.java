...
public class MobBucketItem extends ItemBucket {
    ...
    private void spawn(WorldServer worldserver, ItemStack itemstack, BlockPosition blockposition) {
        Entity entity = this.type.create(worldserver, EntityTypes.createDefaultStackConfig(worldserver, itemstack, (EntityHuman) null), blockposition, EntitySpawnReason.BUCKET, true, false);
