...
public class BundleItem extends Item {
    ...
    private final MinecraftKey openFrontModel;
    private final MinecraftKey openBackModel;

    public BundleItem(MinecraftKey minecraftkey, MinecraftKey minecraftkey1, Item.Info item_info) {
        super(item_info);
        this.openFrontModel = minecraftkey;
        this.openBackModel = minecraftkey1;
    }
    ...
    public MinecraftKey openFrontModel() {
        return this.openFrontModel;
    }

    public MinecraftKey openBackModel() {
