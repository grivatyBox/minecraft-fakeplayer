...
public class CreakingAi {
    ...
    static void initIdleActivity(BehaviorController<Creaking> behaviorcontroller) {
        ...
        }), SetEntityLookTargetSometimes.create(8.0F, UniformInt.of(30, 60)), new BehaviorGateSingle<>(ImmutableList.of(Pair.of(BehaviorStrollRandomUnconstrained.stroll(0.2F), 2), Pair.of(BehaviorLookWalk.create(0.2F, 3), 2), Pair.of(new BehaviorNop(30, 60), 1)))));
    }
