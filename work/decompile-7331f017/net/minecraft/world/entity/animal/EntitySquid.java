...
public class EntitySquid extends AgeableWaterCreature {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new EntitySquid.PathfinderGoalSquid(this, this));
    ...
    @Override
    public @Nullable GroupDataEntity finalizeSpawn(WorldAccess worldaccess, DifficultyDamageScaler difficultydamagescaler, EntitySpawnReason entityspawnreason, @Nullable GroupDataEntity @nullable groupdataentity) {
        GroupDataEntity groupdataentity = (GroupDataEntity)Objects.requireNonNullElseGet(@nullable groupdataentity, () -> {
    ...
    private class PathfinderGoalSquid extends PathfinderGoal {
        ...
        public PathfinderGoalSquid(final EntitySquid entitysquid, final EntitySquid entitysquid1) {
            this.squid = entitysquid1;
        }
