...
public class EntitySalmon extends EntityFishSchool implements VariantHolder<EntitySalmon.a> {
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntitySalmon.DATA_TYPE, EntitySalmon.a.MEDIUM.type);
    }
    ...
    public void setVariant(EntitySalmon.a entitysalmon_a) {
        this.entityData.set(EntitySalmon.DATA_TYPE, entitysalmon_a.type);
    }

    @Override
    public EntitySalmon.a getVariant() {
        return EntitySalmon.a.byName((String) this.entityData.get(EntitySalmon.DATA_TYPE));
    }
