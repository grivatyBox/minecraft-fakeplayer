...
public class AutoRecipeStackManager<T> {
    ...
    boolean hasAnyAmount(T t0) {
        return this.amounts.getInt(t0) > 0;
    }
    ...
    public boolean tryPick(List<AutoRecipeStackManager.a<T>> list, int i, @Nullable AutoRecipeStackManager.b<T> autorecipestackmanager_b) {
        return (new AutoRecipeStackManager.c(list)).tryPick(i, autorecipestackmanager_b);
    }

    public int tryPickAll(List<AutoRecipeStackManager.a<T>> list, int i, @Nullable AutoRecipeStackManager.b<T> autorecipestackmanager_b) {
    ...
    private class c {
        ...
        private final List<AutoRecipeStackManager.a<T>> ingredients;
        ...
        private void setInitialConnections() {
            for (int i = 0; i < this.ingredientCount; ++i) {
                List<T> list = ((AutoRecipeStackManager.a) this.ingredients.get(i)).allowedItems();
        ...
        private List<T> getUniqueAvailableIngredientItems() {
            ...
            while (iterator.hasNext()) {
                ...
                set.addAll(autorecipestackmanager_a.allowedItems());
            }

            set.removeIf((object) -> {
                return !AutoRecipeStackManager.this.hasAnyAmount(object);
            });
        ...
        private int getMinIngredientCount() {
            ...
            while (iterator.hasNext()) {
                ...
                for (Iterator iterator1 = autorecipestackmanager_a.allowedItems().iterator(); iterator1.hasNext(); j = Math.max(j, AutoRecipeStackManager.this.amounts.getInt(object))) {
    ...
    public static record a<T>(List<T> allowedItems) {
