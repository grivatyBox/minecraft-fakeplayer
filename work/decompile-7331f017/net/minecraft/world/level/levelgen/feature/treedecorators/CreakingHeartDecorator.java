    ...
    public void place(WorldGenFeatureTree.a worldgenfeaturetree_a) {
        ...
        if (!list.isEmpty()) {
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (!optional.isEmpty()) {
                    worldgenfeaturetree_a.setBlock((BlockPosition) optional.get(), (IBlockData) Blocks.CREAKING_HEART.defaultBlockState().setValue(CreakingHeartBlock.CREAKING, CreakingHeartBlock.a.DORMANT));
                }
            }
        }
    }
