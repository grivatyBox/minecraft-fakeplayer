        ...
        if (!list.isEmpty()) {
            ...
            worldgenfeaturetree_a.logs().forEach((blockposition1) -> {
                ...
                if (randomsource.nextFloat() < this.trunkProbability) {
                    blockposition2 = blockposition1.below();
                ...
                if (randomsource.nextFloat() < this.trunkProbability) {
                    blockposition2 = blockposition1.above();
                    if (worldgenfeaturetree_a.isAir(blockposition2)) {
                        MossyCarpetBlock.placeAt((GeneratorAccessSeed) worldgenfeaturetree_a.level(), blockposition2, worldgenfeaturetree_a.random(), 3);
                    }
                }
