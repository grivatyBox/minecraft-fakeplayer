...
public class Blocks {
    ...
    public static final Block PALE_OAK_WOOD = register("pale_oak_wood", BlockRotatable::new, BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASS).strength(2.0F).sound(SoundEffectType.WOOD).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    public static final Block PALE_OAK_PLANKS = register("pale_oak_planks", BlockBase.Info.of().mapColor(MaterialMapColor.QUARTZ).instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.QUARTZ).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Block PALE_OAK_LOG = register("pale_oak_log", BlockRotatable::new, logProperties(Blocks.PALE_OAK_PLANKS.defaultMapColor(), Blocks.PALE_OAK_WOOD.defaultMapColor(), SoundEffectType.WOOD).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Block STRIPPED_PALE_OAK_LOG = register("stripped_pale_oak_log", BlockRotatable::new, logProperties(Blocks.PALE_OAK_PLANKS.defaultMapColor(), Blocks.PALE_OAK_PLANKS.defaultMapColor(), SoundEffectType.WOOD).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Block STRIPPED_PALE_OAK_WOOD = register("stripped_pale_oak_wood", BlockRotatable::new, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(2.0F).sound(SoundEffectType.WOOD).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Block ALLIUM = register("allium", (blockbase_info) -> {
        return new BlockFlowers(MobEffects.FIRE_RESISTANCE, 4.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block AZURE_BLUET = register("azure_bluet", (blockbase_info) -> {
        return new BlockFlowers(MobEffects.BLINDNESS, 8.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block RED_TULIP = register("red_tulip", (blockbase_info) -> {
        return new BlockFlowers(MobEffects.WEAKNESS, 9.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block OXEYE_DAISY = register("oxeye_daisy", (blockbase_info) -> {
        return new BlockFlowers(MobEffects.REGENERATION, 8.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block CORNFLOWER = register("cornflower", (blockbase_info) -> {
        return new BlockFlowers(MobEffects.JUMP, 6.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block WITHER_ROSE = register("wither_rose", (blockbase_info) -> {
        return new BlockWitherRose(MobEffects.WITHER, 8.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block LILY_OF_THE_VALLEY = register("lily_of_the_valley", (blockbase_info) -> {
        return new BlockFlowers(MobEffects.POISON, 12.0F, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block CREAKING_HEART = register("creaking_heart", CreakingHeartBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).instrument(BlockPropertyInstrument.BASEDRUM).strength(5.0F).sound(SoundEffectType.CREAKING_HEART).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, wallVariant(Blocks.PALE_OAK_SIGN, true).mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, wallVariant(Blocks.PALE_OAK_HANGING_SIGN, true).mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.STONE).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).requiresCorrectToolForDrops().strength(5.0F).noOcclusion().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Block BREWING_STAND = register("brewing_stand", BlockBrewingStand::new, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).requiresCorrectToolForDrops().strength(0.5F).lightLevel((iblockdata) -> {
        return 1;
    }).noOcclusion());
    ...
    public static final Block ENDER_CHEST = register("ender_chest", BlockEnderChest::new, BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(22.5F, 600.0F).lightLevel((iblockdata) -> {
        return 7;
    }));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.GOLD).forceSolidOn().requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).forceSolidOn().requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block PALE_OAK_SLAB = register("pale_oak_slab", BlockStepAbstract::new, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava().requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Block PALE_OAK_FENCE = register("pale_oak_fence", BlockFence::new, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava().sound(SoundEffectType.WOOD).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY).requiredFeatures(FeatureFlags.WINTER_DROP));
    ...
    public static final Block BELL = register("bell", BlockBell::new, BlockBase.Info.of().mapColor(MaterialMapColor.GOLD).forceSolidOn().requiresCorrectToolForDrops().strength(5.0F).sound(SoundEffectType.ANVIL).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block LANTERN = register("lantern", BlockLantern::new, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).forceSolidOn().requiresCorrectToolForDrops().strength(3.5F).sound(SoundEffectType.LANTERN).lightLevel((iblockdata) -> {
        return 15;
    }).noOcclusion().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block SOUL_LANTERN = register("soul_lantern", BlockLantern::new, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).forceSolidOn().requiresCorrectToolForDrops().strength(3.5F).sound(SoundEffectType.LANTERN).lightLevel((iblockdata) -> {
        return 10;
    }).noOcclusion().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLACK).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.COPPER_BLOCK.defaultMapColor()).strength(3.0F, 6.0F).noOcclusion().requiresCorrectToolForDrops().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_LIGHT_GRAY).strength(0.1F).sound(SoundEffectType.MOSS).pushReaction(EnumPistonReaction.DESTROY).requiredFeatures(FeatureFlags.WINTER_DROP));
    public static final Block PALE_MOSS_CARPET = register("pale_moss_carpet", MossyCarpetBlock::new, BlockBase.Info.of().mapColor(Blocks.PALE_MOSS_BLOCK.defaultMapColor()).strength(0.1F).sound(SoundEffectType.MOSS_CARPET).pushReaction(EnumPistonReaction.DESTROY).requiredFeatures(FeatureFlags.WINTER_DROP));
    public static final Block PALE_HANGING_MOSS = register("pale_hanging_moss", HangingMossBlock::new, BlockBase.Info.of().mapColor(Blocks.PALE_MOSS_BLOCK.defaultMapColor()).strength(0.1F).noCollission().sound(SoundEffectType.MOSS_CARPET).pushReaction(EnumPistonReaction.DESTROY).requiredFeatures(FeatureFlags.WINTER_DROP));
