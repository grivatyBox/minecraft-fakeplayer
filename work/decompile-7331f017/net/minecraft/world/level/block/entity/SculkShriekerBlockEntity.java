...
public class SculkShriekerBlockEntity extends TileEntity implements GameEventListener.b<VibrationSystem.b>, VibrationSystem {
    ...
    private boolean trySummonWarden(WorldServer worldserver) {
        return this.warningLevel < 4 ? false : SpawnUtil.trySpawnMob(EntityTypes.WARDEN, EntitySpawnReason.TRIGGERED, worldserver, this.getBlockPos(), 20, 5, 6, SpawnUtil.a.ON_TOP_OF_COLLIDER).isPresent();
    }
