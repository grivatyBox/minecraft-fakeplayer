...
public class MultiNoiseBiomeSourceParameterList {
    ...
    public static record a(MinecraftKey id, MultiNoiseBiomeSourceParameterList.a.a provider) {
        ...
        public static final MultiNoiseBiomeSourceParameterList.a OVERWORLD_WINTER_DROP = new MultiNoiseBiomeSourceParameterList.a(MinecraftKey.withDefaultNamespace("overworld_winter_drop"), new MultiNoiseBiomeSourceParameterList.a.a() {
            @Override
            public <T> Climate.c<T> apply(Function<ResourceKey<BiomeBase>, T> function) {
                return MultiNoiseBiomeSourceParameterList.a.generateOverworldBiomes(function, OverworldBiomeBuilder.a.WINTER_DROP);
            }
        });
        static final Map<MinecraftKey, MultiNoiseBiomeSourceParameterList.a> BY_NAME = (Map) Stream.of(MultiNoiseBiomeSourceParameterList.a.NETHER, MultiNoiseBiomeSourceParameterList.a.OVERWORLD, MultiNoiseBiomeSourceParameterList.a.OVERWORLD_WINTER_DROP).collect(Collectors.toMap(MultiNoiseBiomeSourceParameterList.a::id, (multinoisebiomesourceparameterlist_a) -> {
            return multinoisebiomesourceparameterlist_a;
        }));
