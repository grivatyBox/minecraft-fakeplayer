...
public final class OverworldBiomeBuilder {
    ...
    private final ResourceKey<BiomeBase>[][] PLATEAU_BIOMES_VARIANT_WINTER_DROP;
    ...
    private ResourceKey<BiomeBase> pickPlateauBiome(int i, int j, Climate.b climate_b) {
        if (climate_b.max() >= 0L) {
            ResourceKey<BiomeBase> resourcekey = (this.modifier == OverworldBiomeBuilder.a.WINTER_DROP ? this.PLATEAU_BIOMES_VARIANT_WINTER_DROP : this.PLATEAU_BIOMES_VARIANT)[i][j];
