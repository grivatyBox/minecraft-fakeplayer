...
public class MultiNoiseBiomeSourceParameterLists {
    ...
    public static void winterDrop(BootstrapContext<MultiNoiseBiomeSourceParameterList> bootstrapcontext) {
        ...
        bootstrapcontext.register(MultiNoiseBiomeSourceParameterLists.OVERWORLD, new MultiNoiseBiomeSourceParameterList(MultiNoiseBiomeSourceParameterList.a.OVERWORLD_WINTER_DROP, holdergetter));
    }
