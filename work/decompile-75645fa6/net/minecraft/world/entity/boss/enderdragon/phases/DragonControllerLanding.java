...
public class DragonControllerLanding extends AbstractDragonController {
    ...
    public void doClientTick() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            this.dragon.level().addParticle(PowerParticleOption.create(Particles.DRAGON_BREATH, 1.0F), d3, d4, d5, -vec3d.x * (double) 0.08F + vec3d1.x, -vec3d.y * (double) 0.3F + vec3d1.y, -vec3d.z * (double) 0.08F + vec3d1.z);
