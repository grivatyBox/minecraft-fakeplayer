...
public class VillagePlace extends RegionFileSection<VillagePlaceSection, VillagePlaceSection.a> {
    ...
    @Nullable
    public VillagePlaceRecord add(BlockPosition blockposition, Holder<VillagePlaceType> holder) {
        return ((VillagePlaceSection) this.getOrCreate(SectionPosition.asLong(blockposition))).add(blockposition, holder);
    }
    ...
    @Nullable
    @VisibleForDebug
    public DebugPoiInfo getDebugPoiInfo(BlockPosition blockposition) {
        return (DebugPoiInfo) this.getOrLoad(SectionPosition.asLong(blockposition)).flatMap((villageplacesection) -> {
            return villageplacesection.getDebugPoiInfo(blockposition);
        }).orElse((Object) null);
    }
