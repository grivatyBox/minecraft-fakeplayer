    ...
    public void tick() {
        ...
        if (!blockposition.closerToCenterThan(this.mob.position(), this.acceptedDistance())) {
            ...
            if (this.shouldRecalculatePath()) {
                this.mob.getNavigation().moveTo((double) blockposition.getX() + 0.5D, (double) blockposition.getY(), (double) blockposition.getZ() + 0.5D, this.speedModifier);
            }
        } else {
            ...
            for (int l = 0; l < i; ++l) {
                for (int i1 = 0; i1 <= l; i1 = i1 > 0 ? -i1 : 1 - i1) {
                    for (int j1 = i1 < l && i1 > -l ? l : 0; j1 <= l; j1 = j1 > 0 ? -j1 : 1 - j1) {
                        ...
                        if (this.mob.isWithinHome((BlockPosition) blockposition_mutableblockposition) && this.isValidTarget(this.mob.level(), blockposition_mutableblockposition)) {
