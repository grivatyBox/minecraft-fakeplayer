...
public class Navigation extends NavigationAbstract {
    ...
    public PathEntity createPath(BlockPosition blockposition, int i) {
        ...
        if (chunk == null) {
            ...
            if (!this.canPathToTargetsBelowSurface) {
                blockposition = this.findSurfacePosition(chunk, blockposition, i);
            }
    ...
    final BlockPosition findSurfacePosition(Chunk chunk, BlockPosition blockposition, int i) {
        if (chunk.getBlockState(blockposition).isAir()) {
            ...
            if (blockposition_mutableblockposition.getY() >= this.level.getMinY()) {
                return blockposition_mutableblockposition.above();
            }
        ...
        if (!chunk.getBlockState(blockposition).isSolid()) {
            ...
            return blockposition_mutableblockposition1.immutable();
        }
    }
    ...
    public void setCanPathToTargetsBelowSurface(boolean flag) {
        this.canPathToTargetsBelowSurface = flag;
    }
}
