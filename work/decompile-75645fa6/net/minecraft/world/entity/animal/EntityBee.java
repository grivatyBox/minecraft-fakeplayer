...
public class EntityBee extends EntityAnimal implements IEntityAngerable, EntityBird {
    ...
    public static boolean isNightOrRaining(World world) {
        return world.dimensionType().hasSkyLight() && world.dimension() != World.END && (world.isDarkOutside() || world.isRaining());
    }
    ...
    public void registerDebugValues(WorldServer worldserver, DebugValueSource.a debugvaluesource_a) {
        ...
        debugvaluesource_a.register(DebugSubscriptions.BEES, () -> {
