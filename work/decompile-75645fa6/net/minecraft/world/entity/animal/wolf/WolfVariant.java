...
public record WolfVariant(WolfVariant.a assetInfo, SpawnPrioritySelectors spawnConditions) implements PriorityProvider<SpawnContext, SpawnCondition> {
    ...
    public static record a(ClientAsset.b wild, ClientAsset.b tame, ClientAsset.b angry) {

        public static final Codec<WolfVariant.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ClientAsset.b.CODEC.fieldOf("wild").forGetter(WolfVariant.a::wild), ClientAsset.b.CODEC.fieldOf("tame").forGetter(WolfVariant.a::tame), ClientAsset.b.CODEC.fieldOf("angry").forGetter(WolfVariant.a::angry)).apply(instance, WolfVariant.a::new);
        });
    }
}
