...
public class Armadillo extends EntityAnimal {
    ...
    public EnumInteractionResult mobInteract(EntityHuman entityhuman, EnumHand enumhand) {
        ...
        if (itemstack.is(Items.BRUSH) && this.brushOffScute(entityhuman, itemstack)) {
            itemstack.hurtAndBreak(16, entityhuman, enumhand.asEquipmentSlot());
    ...
    public boolean brushOffScute(@Nullable Entity entity, ItemStack itemstack) {
        if (this.isBaby()) {
            ...
            if (world instanceof WorldServer) {
                ...
                this.dropFromEntityInteractLootTable(worldserver, LootTables.ARMADILLO_BRUSH, entity, itemstack, this::spawnAtLocation);
