...
public abstract class Display extends Entity {
    ...
    protected void readAdditionalSaveData(ValueInput valueinput) {
        ...
        this.setBillboardConstraints((Display.BillboardConstraints) valueinput.read("billboard", Display.BillboardConstraints.CODEC).orElse(Display.BillboardConstraints.FIXED));
        ...
        this.setBrightnessOverride((Brightness) valueinput.read("brightness", Brightness.CODEC).orElse((Object) null));
    }
    ...
    public static class BlockDisplay extends Display {
        ...
        protected void readAdditionalSaveData(ValueInput valueinput) {
            super.readAdditionalSaveData(valueinput);
            this.setBlockState((IBlockData) valueinput.read("block_state", IBlockData.CODEC).orElse(Blocks.AIR.defaultBlockState()));
        }
    ...
    public static class TextDisplay extends Display {
        ...
        private static byte loadFlag(byte b0, ValueInput valueinput, String s, byte b1) {
            return valueinput.getBooleanOr(s, false) ? (byte) (b0 | b1) : b0;
        }
        ...
        protected void readAdditionalSaveData(ValueInput valueinput) {
            ...
            byte b0 = loadFlag((byte) 0, valueinput, "shadow", (byte) 1);

            b0 = loadFlag(b0, valueinput, "see_through", (byte) 2);
            b0 = loadFlag(b0, valueinput, "default_background", (byte) 4);
            Optional<Display.TextDisplay.Align> optional = valueinput.<Display.TextDisplay.Align>read("alignment", Display.TextDisplay.Align.CODEC);
            ...
            this.setFlags(b0);
            Optional<IChatBaseComponent> optional1 = valueinput.<IChatBaseComponent>read("text", ComponentSerialization.CODEC);
            ...
            if (optional1.isPresent()) {
                try {
                    ...
                    if (world instanceof WorldServer) {
                        ...
                        IChatBaseComponent ichatbasecomponent = ChatComponentUtils.updateForEntity(commandlistenerwrapper, (IChatBaseComponent) optional1.get(), this, 0);

                        this.setText(ichatbasecomponent);
                    } else {
        ...
        private static void storeFlag(byte b0, ValueOutput valueoutput, String s, byte b1) {
            valueoutput.putBoolean(s, (b0 & b1) != 0);
        }
        ...
        protected void addAdditionalSaveData(ValueOutput valueoutput) {
            ...
            storeFlag(b0, valueoutput, "shadow", (byte) 1);
            storeFlag(b0, valueoutput, "see_through", (byte) 2);
            storeFlag(b0, valueoutput, "default_background", (byte) 4);
            valueoutput.store("alignment", Display.TextDisplay.Align.CODEC, getAlign(b0));
        }
