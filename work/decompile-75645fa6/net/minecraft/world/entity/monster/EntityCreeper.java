...
public class EntityCreeper extends EntityMonster {
    ...
    public boolean killedEntity(WorldServer worldserver, EntityLiving entityliving, DamageSource damagesource) {
        if (this.shouldDropLoot(worldserver) && this.isPowered() && !this.droppedSkulls) {
            entityliving.dropFromLootTable(worldserver, damagesource, false, LootTables.CHARGED_CREEPER, (itemstack) -> {
                entityliving.spawnAtLocation(worldserver, itemstack);
                this.droppedSkulls = true;
            });
        }

        return super.killedEntity(worldserver, entityliving, damagesource);
    }
