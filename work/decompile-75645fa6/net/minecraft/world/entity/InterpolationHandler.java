...
public class InterpolationHandler {
    ...
    public void interpolateTo(Vec3D vec3d, float f, float f1) {
        if (this.interpolationSteps == 0) {
            ...
            this.cancel();
        } else if (!this.hasActiveInterpolation() || !Objects.equals(this.yRot(), f) || !Objects.equals(this.xRot(), f1) || !Objects.equals(this.position(), vec3d)) {
    ...
    public void interpolate() {
        if (!this.hasActiveInterpolation()) {
            ...
            if (this.previousTickPosition != null) {
                ...
                if (this.entity.level().noCollision(this.entity, this.entity.makeBoundingBox(this.interpolationData.position.add(vec3d)))) {
