...
public class EntityMinecartTNT extends EntityMinecartAbstract {
    ...
    public void explode(@Nullable DamageSource damagesource, double d0) {
    ...
    protected void readAdditionalSaveData(ValueInput valueinput) {
        ...
        this.explosionPowerBase = MathHelper.clamp(valueinput.getFloatOr("explosion_power", 4.0F), 0.0F, 128.0F);
        this.explosionSpeedFactor = MathHelper.clamp(valueinput.getFloatOr("explosion_speed_factor", 1.0F), 0.0F, 128.0F);
    }
