...
public abstract class AbstractBoat extends VehicleEntity implements Leashable {
    ...
    public static boolean canVehicleCollide(Entity entity, Entity entity1) {
        return (entity1.canBeCollidedWith(entity) || entity1.isPushable()) && !entity.isPassengerOfSameVehicle(entity1);
    }
        ...
        if (!list.isEmpty()) {
            ...
            for (Entity entity : list) {
                if (!entity.hasPassenger(this)) {
                    if (flag && this.getPassengers().size() < this.getMaxPassengers() && !entity.isPassenger() && this.hasEnoughSpaceFor(entity) && entity instanceof EntityLiving && !entity.getType().is(TagsEntity.CANNOT_BE_PUSHED_ONTO_BOATS)) {
    ...
    public Vec3D getLeashOffset() {
        return new Vec3D(0.0D, (double) (0.88F * this.getBbHeight()), (double) (0.64F * this.getBbWidth()));
    }
