...
public class BreezeWindCharge extends AbstractWindCharge {
    ...
    public void explode(Vec3D vec3d) {
        this.level().explode(this, (DamageSource) null, BreezeWindCharge.EXPLOSION_DAMAGE_CALCULATOR, vec3d.x(), vec3d.y(), vec3d.z(), 3.0F, false, World.a.TRIGGER, Particles.GUST_EMITTER_SMALL, Particles.GUST_EMITTER_LARGE, WeightedList.of(), SoundEffects.BREEZE_WIND_CHARGE_BURST);
    }
}
