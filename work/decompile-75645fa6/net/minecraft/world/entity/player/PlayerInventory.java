...
public class PlayerInventory implements IInventory, INamableTileEntity {
    ...
    public void save(ValueOutput.a<ItemStackWithSlot> valueoutput_a) {
        for (int i = 0; i < this.items.size(); ++i) {
            ItemStack itemstack = this.items.get(i);
    ...
    public void load(ValueInput.a<ItemStackWithSlot> valueinput_a) {
        this.items.clear();
    ...
    public IChatBaseComponent getName() {
        return PlayerInventory.DEFAULT_NAME;
    }
