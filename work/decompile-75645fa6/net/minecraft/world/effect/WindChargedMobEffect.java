...
class WindChargedMobEffect extends MobEffectList {
    ...
    public void onMobRemoved(WorldServer worldserver, EntityLiving entityliving, int i, Entity.RemovalReason entity_removalreason) {
        if (entity_removalreason == Entity.RemovalReason.KILLED) {
            ...
            worldserver.explode(entityliving, (DamageSource) null, AbstractWindCharge.EXPLOSION_DAMAGE_CALCULATOR, d0, d1, d2, f, false, World.a.TRIGGER, Particles.GUST_EMITTER_SMALL, Particles.GUST_EMITTER_LARGE, WeightedList.of(), SoundEffects.BREEZE_WIND_CHARGE_BURST);
        }
