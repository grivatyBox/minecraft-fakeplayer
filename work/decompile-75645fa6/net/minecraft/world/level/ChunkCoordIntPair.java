...
public class ChunkCoordIntPair {
    ...
    public boolean contains(BlockPosition blockposition) {
        return blockposition.getX() >= this.getMinBlockX() && blockposition.getZ() >= this.getMinBlockZ() && blockposition.getX() <= this.getMaxBlockX() && blockposition.getZ() <= this.getMaxBlockZ();
    }
