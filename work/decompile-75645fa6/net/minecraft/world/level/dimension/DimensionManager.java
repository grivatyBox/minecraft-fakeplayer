...
public record DimensionManager(OptionalLong fixedTime, boolean hasSkyLight, boolean hasCeiling, boolean ultraWarm, boolean natural, double coordinateScale, boolean bedWorks, boolean respawnAnchorWorks, int minY, int height, int logicalHeight, TagKey<Block> infiniburn, MinecraftKey effectsLocation, float ambientLight, Optional<Integer> cloudHeight, DimensionManager.a monsterSettings) {
    ...
    public DimensionManager(OptionalLong optionallong, boolean flag, boolean flag1, boolean flag2, boolean flag3, double d0, boolean flag4, boolean flag5, int i, int j, int k, TagKey<Block> tagkey, MinecraftKey minecraftkey, float f, Optional<Integer> optional, DimensionManager.a dimensionmanager_a) {
        if (j < 16) {
