...
public class TileEntityChest extends TileEntityLootable implements LidBlockEntity {
    ...
    private static final IChatBaseComponent DEFAULT_NAME = IChatBaseComponent.translatable("container.chest");
        ...
        this.openersCounter = new ContainerOpenersCounter() {
            ...
            protected void onOpen(World world, BlockPosition blockposition1, IBlockData iblockdata1) {
                ...
                if (block instanceof BlockChest blockchest) {
                    TileEntityChest.playSound(world, blockposition1, iblockdata1, blockchest.getOpenChestSound());
                }
            ...
            protected void onClose(World world, BlockPosition blockposition1, IBlockData iblockdata1) {
                ...
                if (block instanceof BlockChest blockchest) {
                    TileEntityChest.playSound(world, blockposition1, iblockdata1, blockchest.getCloseChestSound());
                }
            ...
            @Override
            public boolean isOwnContainer(EntityHuman entityhuman) {
    ...
    protected IChatBaseComponent getDefaultName() {
        return TileEntityChest.DEFAULT_NAME;
    }
