...
public class TileEntityBlastFurnace extends TileEntityFurnace {
    ...
    private static final IChatBaseComponent DEFAULT_NAME = IChatBaseComponent.translatable("container.blast_furnace");
    ...
    protected IChatBaseComponent getDefaultName() {
        return TileEntityBlastFurnace.DEFAULT_NAME;
    }
