...
public class BlockIronBars extends BlockTall {
    ...
    protected boolean skipRendering(IBlockData iblockdata, IBlockData iblockdata1, EnumDirection enumdirection) {
        if (iblockdata1.is(this) || iblockdata1.is(TagsBlock.BARS) && iblockdata.is(TagsBlock.BARS) && iblockdata1.hasProperty((IBlockState) BlockIronBars.PROPERTY_BY_DIRECTION.get(enumdirection.getOpposite()))) {
