...
public class BlockProperties {
    ...
    public static final BlockStateEnum<SideChainPart> SIDE_CHAIN_PART = BlockStateEnum.<SideChainPart>create("side_chain", SideChainPart.class);
    ...
    public static final BlockStateInteger DRIED_GHAST_HYDRATION_LEVELS = BlockStateInteger.create("hydration", 0, 3);
    ...
    public static final BlockStateBoolean SLOT_0_OCCUPIED = BlockStateBoolean.create("slot_0_occupied");
    public static final BlockStateBoolean SLOT_1_OCCUPIED = BlockStateBoolean.create("slot_1_occupied");
    public static final BlockStateBoolean SLOT_2_OCCUPIED = BlockStateBoolean.create("slot_2_occupied");
    public static final BlockStateBoolean SLOT_3_OCCUPIED = BlockStateBoolean.create("slot_3_occupied");
    public static final BlockStateBoolean SLOT_4_OCCUPIED = BlockStateBoolean.create("slot_4_occupied");
    public static final BlockStateBoolean SLOT_5_OCCUPIED = BlockStateBoolean.create("slot_5_occupied");
    ...
    public static final BlockStateEnum<CopperGolemStatueBlock.a> COPPER_GOLEM_POSE = BlockStateEnum.<CopperGolemStatueBlock.a>create("copper_golem_pose", CopperGolemStatueBlock.a.class);
