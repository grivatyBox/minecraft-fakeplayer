...
public class BlockRedstoneComparator extends BlockDiodeAbstract implements ITileEntity {
    ...
    protected int getInputSignal(World world, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        if (iblockdata1.hasAnalogOutputSignal()) {
            i = iblockdata1.getAnalogOutputSignal(world, blockposition1, enumdirection.getOpposite());
            ...
            int j = Math.max(entityitemframe == null ? Integer.MIN_VALUE : entityitemframe.getAnalogOutput(), iblockdata1.hasAnalogOutputSignal() ? iblockdata1.getAnalogOutputSignal(world, blockposition1, enumdirection.getOpposite()) : Integer.MIN_VALUE);
