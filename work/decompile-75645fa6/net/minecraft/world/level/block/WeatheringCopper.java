...
public interface WeatheringCopper extends ChangeOverTimeBlock<WeatheringCopper.a> {
    ...
    public static enum a implements INamable {
        ...
        public static final IntFunction<WeatheringCopper.a> BY_ID = ByIdMap.<WeatheringCopper.a>continuous(Enum::ordinal, values(), ByIdMap.a.CLAMP);
        public static final Codec<WeatheringCopper.a> CODEC = INamable.<WeatheringCopper.a>fromEnum(WeatheringCopper.a::values);
        public static final StreamCodec<ByteBuf, WeatheringCopper.a> STREAM_CODEC = ByteBufCodecs.idMapper(WeatheringCopper.a.BY_ID, Enum::ordinal);
        ...
        public WeatheringCopper.a next() {
            return (WeatheringCopper.a) WeatheringCopper.a.BY_ID.apply(this.ordinal() + 1);
        }

        public WeatheringCopper.a previous() {
            return (WeatheringCopper.a) WeatheringCopper.a.BY_ID.apply(this.ordinal() - 1);
        }
    }
}
