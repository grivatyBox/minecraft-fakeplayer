...
public class SoundEffectType {
    ...
    public static final SoundEffectType COPPER_GOLEM_STATUE = new SoundEffectType(1.0F, 1.0F, SoundEffects.COPPER_GOLEM_STATUE_BREAK, SoundEffects.COPPER_GOLEM_STATUE_STEP, SoundEffects.COPPER_GOLEM_STATUE_PLACE, SoundEffects.COPPER_GOLEM_STATUE_HIT, SoundEffects.COPPER_GOLEM_STATUE_FALL);
    ...
    public static final SoundEffectType SHELF = new SoundEffectType(1.0F, 1.0F, SoundEffects.SHELF_BREAK, SoundEffects.SHELF_STEP, SoundEffects.SHELF_PLACE, SoundEffects.SHELF_HIT, SoundEffects.SHELF_FALL);
    ...
    public static final SoundEffectType DRIED_GHAST = new SoundEffectType(1.0F, 1.0F, SoundEffects.DRIED_GHAST_BREAK, SoundEffects.DRIED_GHAST_STEP, SoundEffects.EMPTY, SoundEffects.EMPTY, SoundEffects.DRIED_GHAST_FALL);
