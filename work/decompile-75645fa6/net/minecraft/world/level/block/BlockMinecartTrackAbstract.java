...
public abstract class BlockMinecartTrackAbstract extends Block implements IBlockWaterlogged {
    ...
    protected BlockPropertyTrackPosition rotate(BlockPropertyTrackPosition blockpropertytrackposition, EnumBlockRotation enumblockrotation) {
            ...
            case CLOCKWISE_180:
                switch (blockpropertytrackposition) {
                    case ASCENDING_EAST:
                        ...
                        return blockpropertytrackposition1;
                    case ASCENDING_WEST:
    ...
    protected BlockPropertyTrackPosition mirror(BlockPropertyTrackPosition blockpropertytrackposition, EnumBlockMirror enumblockmirror) {
        BlockPropertyTrackPosition blockpropertytrackposition1;
