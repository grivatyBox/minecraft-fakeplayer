...
public class WeatheringLightningRodBlock extends LightningRodBlock implements WeatheringCopper {
    ...
    public static final MapCodec<WeatheringLightningRodBlock> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(WeatheringCopper.a.CODEC.fieldOf("weathering_state").forGetter(WeatheringLightningRodBlock::getAge), propertiesCodec()).apply(instance, WeatheringLightningRodBlock::new);
    });
    ...
    protected WeatheringLightningRodBlock(WeatheringCopper.a weatheringcopper_a, BlockBase.Info blockbase_info) {
