...
public class Blocks {
    ...
    public static final Block AIR = register("air", BlockAir::new, BlockBase.Info.of().replaceable().noCollision().noLootTable().air());
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PINK).noCollision().randomTicks().instabreak().sound(SoundEffectType.CHERRY_SAPLING).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).noCollision().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.WATER).replaceable().noCollision().strength(100.0F).pushReaction(EnumPistonReaction.DESTROY).noLootTable().liquid().sound(SoundEffectType.EMPTY));
    public static final Block LAVA = register("lava", (blockbase_info) -> {
        return new BlockFluids(FluidTypes.LAVA, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.FIRE).replaceable().noCollision().randomTicks().strength(100.0F).lightLevel((iblockdata) -> {
        return 15;
    ...
    public static final Block POWERED_RAIL = register("powered_rail", BlockPoweredRail::new, BlockBase.Info.of().noCollision().strength(0.7F).sound(SoundEffectType.METAL));
    public static final Block DETECTOR_RAIL = register("detector_rail", BlockMinecartDetector::new, BlockBase.Info.of().noCollision().strength(0.7F).sound(SoundEffectType.METAL));
    public static final Block STICKY_PISTON = register("sticky_piston", (blockbase_info) -> {
        return new BlockPiston(true, blockbase_info);
    }, pistonProperties());
    public static final Block COBWEB = register("cobweb", BlockWeb::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOL).sound(SoundEffectType.COBWEB).forceSolidOn().noCollision().requiresCorrectToolForDrops().strength(4.0F).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block SHORT_GRASS = register("short_grass", BlockLongGrass::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XYZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block FERN = register("fern", BlockLongGrass::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XYZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block DEAD_BUSH = register("dead_bush", DryVegetationBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).replaceable().noCollision().instabreak().sound(SoundEffectType.GRASS).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block BUSH = register("bush", BlockPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollision().instabreak().sound(SoundEffectType.GRASS).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block SEAGRASS = register("seagrass", SeagrassBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WATER).replaceable().noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block TALL_SEAGRASS = register("tall_seagrass", TallSeagrassBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WATER).replaceable().noCollision().instabreak().sound(SoundEffectType.WET_GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BROWN).noCollision().randomTicks().instabreak().sound(SoundEffectType.GRASS).lightLevel((iblockdata) -> {
        return 1;
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_RED).noCollision().randomTicks().instabreak().sound(SoundEffectType.GRASS).hasPostProcess(Blocks::always).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block ACACIA_SHELF = register("acacia_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block BAMBOO_SHELF = register("bamboo_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block BIRCH_SHELF = register("birch_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block CHERRY_SHELF = register("cherry_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block CRIMSON_SHELF = register("crimson_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block DARK_OAK_SHELF = register("dark_oak_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block JUNGLE_SHELF = register("jungle_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block MANGROVE_SHELF = register("mangrove_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block OAK_SHELF = register("oak_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block PALE_OAK_SHELF = register("pale_oak_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block SPRUCE_SHELF = register("spruce_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    public static final Block WARPED_SHELF = register("warped_shelf", ShelfBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).sound(SoundEffectType.SHELF).ignitedByLava().strength(2.0F, 3.0F));
    ...
    }, BlockBase.Info.of().noCollision().instabreak().lightLevel((iblockdata) -> {
        return 14;
    ...
    }, wallVariant(Blocks.TORCH, true).noCollision().instabreak().lightLevel((iblockdata) -> {
        return 14;
    }).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block FIRE = register("fire", BlockFire::new, BlockBase.Info.of().mapColor(MaterialMapColor.FIRE).replaceable().noCollision().instabreak().lightLevel((iblockdata) -> {
        return 15;
    }).sound(SoundEffectType.WOOL).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block SOUL_FIRE = register("soul_fire", BlockSoulFire::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_LIGHT_BLUE).replaceable().noCollision().instabreak().lightLevel((iblockdata) -> {
        return 10;
    }).sound(SoundEffectType.WOOL).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block CHEST = register("chest", (blockbase_info) -> {
        ...
        }, SoundEffects.CHEST_OPEN, SoundEffects.CHEST_CLOSE, blockbase_info);
    ...
    public static final Block REDSTONE_WIRE = register("redstone_wire", BlockRedstoneWire::new, BlockBase.Info.of().noCollision().instabreak().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }).noCollision().randomTicks().instabreak().sound(SoundEffectType.CROP).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.SPRUCE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.SAND).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.CHERRY_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.JUNGLE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.DARK_OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.MANGROVE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    public static final Block RAIL = register("rail", BlockMinecartTrack::new, BlockBase.Info.of().noCollision().strength(0.7F).sound(SoundEffectType.METAL));
    ...
    }, wallVariant(Blocks.OAK_SIGN, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.SPRUCE_SIGN, true).mapColor(Blocks.SPRUCE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.BIRCH_SIGN, true).mapColor(MaterialMapColor.SAND).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.ACACIA_SIGN, true).mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.CHERRY_SIGN, true).mapColor(Blocks.CHERRY_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.JUNGLE_SIGN, true).mapColor(Blocks.JUNGLE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.DARK_OAK_SIGN, true).mapColor(Blocks.DARK_OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.PALE_OAK_SIGN, true).mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.MANGROVE_SIGN, true).mapColor(Blocks.MANGROVE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.BAMBOO_SIGN, true).mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_PINK).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.CRIMSON_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.WARPED_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.OAK_HANGING_SIGN, true).mapColor(Blocks.OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.SPRUCE_HANGING_SIGN, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.BIRCH_HANGING_SIGN, true).mapColor(MaterialMapColor.SAND).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.ACACIA_HANGING_SIGN, true).mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.CHERRY_HANGING_SIGN, true).mapColor(MaterialMapColor.TERRACOTTA_PINK).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.JUNGLE_HANGING_SIGN, true).mapColor(Blocks.JUNGLE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.DARK_OAK_HANGING_SIGN, true).mapColor(Blocks.DARK_OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.PALE_OAK_HANGING_SIGN, true).mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.MANGROVE_HANGING_SIGN, true).mapColor(Blocks.MANGROVE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    ...
    }, wallVariant(Blocks.CRIMSON_HANGING_SIGN, true).mapColor(MaterialMapColor.CRIMSON_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F));
    ...
    }, wallVariant(Blocks.WARPED_HANGING_SIGN, true).mapColor(MaterialMapColor.WARPED_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F));
    ...
    }, wallVariant(Blocks.BAMBOO_HANGING_SIGN, true).mapColor(MaterialMapColor.COLOR_YELLOW).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).ignitedByLava());
    public static final Block LEVER = register("lever", BlockLever::new, BlockBase.Info.of().noCollision().strength(0.5F).sound(SoundEffectType.STONE).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.STONE).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).noCollision().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.SPRUCE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.BIRCH_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.JUNGLE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.ACACIA_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.CHERRY_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.DARK_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.MANGROVE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block REDSTONE_TORCH = register("redstone_torch", BlockRedstoneTorch::new, BlockBase.Info.of().noCollision().instabreak().lightLevel(litBlockEmission(7)).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block REDSTONE_WALL_TORCH = register("redstone_wall_torch", BlockRedstoneTorchWall::new, wallVariant(Blocks.REDSTONE_TORCH, true).noCollision().instabreak().lightLevel(litBlockEmission(7)).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block CACTUS_FLOWER = register("cactus_flower", CactusFlowerBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PINK).noCollision().instabreak().ignitedByLava().sound(SoundEffectType.CACTUS_FLOWER).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block SUGAR_CANE = register("sugar_cane", BlockReed::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, wallVariant(Blocks.SOUL_TORCH, true).noCollision().instabreak().lightLevel((iblockdata) -> {
        return 10;
    }).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block COPPER_TORCH = register("copper_torch", (blockbase_info) -> {
        return new BlockTorch(Particles.COPPER_FIRE_FLAME, blockbase_info);
    }, BlockBase.Info.of().noCollision().instabreak().lightLevel((iblockdata) -> {
        return 14;
    }).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block COPPER_WALL_TORCH = register("copper_wall_torch", (blockbase_info) -> {
        return new BlockTorchWall(Particles.COPPER_FIRE_FLAME, blockbase_info);
    }, wallVariant(Blocks.COPPER_TORCH, true).noCollision().instabreak().lightLevel((iblockdata) -> {
        return 14;
    }).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block NETHER_PORTAL = register("nether_portal", BlockPortal::new, BlockBase.Info.of().noCollision().randomTicks().strength(-1.0F).sound(SoundEffectType.GLASS).lightLevel((iblockdata) -> {
        return 11;
    ...
    public static final WeatheringCopperBlocks COPPER_BARS = WeatheringCopperBlocks.create("copper_bars", Blocks::register, BlockIronBars::new, WeatheringCopperBarsBlock::new, (weatheringcopper_a) -> {
        return BlockBase.Info.of().requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundEffectType.COPPER).noOcclusion();
    });
    public static final Block IRON_CHAIN = register("iron_chain", BlockChain::new, BlockBase.Info.of().forceSolidOn().requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundEffectType.CHAIN).noOcclusion());
    public static final WeatheringCopperBlocks COPPER_CHAIN = WeatheringCopperBlocks.create("copper_chain", Blocks::register, BlockChain::new, WeatheringCopperChainBlock::new, (weatheringcopper_a) -> {
        return BlockBase.Info.of().forceSolidOn().requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundEffectType.CHAIN).noOcclusion();
    });
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.HARD_CROP).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block VINE = register("vine", BlockVine::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollision().randomTicks().strength(0.2F).sound(SoundEffectType.VINE).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block GLOW_LICHEN = register("glow_lichen", GlowLichenBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.GLOW_LICHEN).replaceable().noCollision().strength(0.2F).sound(SoundEffectType.GLOW_LICHEN).lightLevel(GlowLichenBlock.emission(7)).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block RESIN_CLUMP = register("resin_clump", MultifaceBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_ORANGE).replaceable().noCollision().sound(SoundEffectType.RESIN).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block NETHER_WART = register("nether_wart", BlockNetherWart::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_RED).noCollision().randomTicks().sound(SoundEffectType.NETHER_WART).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block END_PORTAL = register("end_portal", BlockEnderPortal::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLACK).noCollision().lightLevel((iblockdata) -> {
        return 15;
    ...
    public static final Block TRIPWIRE_HOOK = register("tripwire_hook", BlockTripwireHook::new, BlockBase.Info.of().noCollision().sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().noCollision().pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block CARROTS = register("carrots", BlockCarrots::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.CROP).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block POTATOES = register("potatoes", BlockPotatoes::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.CROP).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.GOLD).forceSolidOn().noCollision().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).forceSolidOn().noCollision().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block ACTIVATOR_RAIL = register("activator_rail", BlockPoweredRail::new, BlockBase.Info.of().noCollision().strength(0.7F).sound(SoundEffectType.METAL));
    ...
    public static final Block SUNFLOWER = register("sunflower", BlockTallPlantFlower::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block LILAC = register("lilac", BlockTallPlantFlower::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block ROSE_BUSH = register("rose_bush", BlockTallPlantFlower::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block PEONY = register("peony", BlockTallPlantFlower::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block TALL_GRASS = register("tall_grass", BlockTallPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block LARGE_FERN = register("large_fern", BlockTallPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.WHITE_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.ORANGE_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.MAGENTA_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.LIGHT_BLUE_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.YELLOW_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.LIME_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.PINK_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.GRAY_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.LIGHT_GRAY_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.CYAN_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.PURPLE_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.BLUE_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.BROWN_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.GREEN_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.RED_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    }, wallVariant(Blocks.BLACK_BANNER, true).mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(1.0F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    public static final Block TORCHFLOWER_CROP = register("torchflower_crop", TorchflowerCropBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.CROP).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block PITCHER_CROP = register("pitcher_crop", PitcherCropBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.CROP).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block PITCHER_PLANT = register("pitcher_plant", BlockTallPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.CROP).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    public static final Block BEETROOTS = register("beetroots", BlockBeetroot::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundEffectType.CROP).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block END_GATEWAY = register("end_gateway", BlockEndGateway::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLACK).noCollision().lightLevel((iblockdata) -> {
        return 15;
    }).strength(-1.0F, 3600000.0F).noLootTable().pushReaction(EnumPistonReaction.BLOCK));
    ...
    public static final Block STRUCTURE_VOID = register("structure_void", BlockStructureVoid::new, BlockBase.Info.of().replaceable().noCollision().noLootTable().noTerrainParticles().pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block KELP = register("kelp", BlockKelp::new, BlockBase.Info.of().mapColor(MaterialMapColor.WATER).noCollision().randomTicks().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block KELP_PLANT = register("kelp_plant", BlockKelpPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.WATER).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block DRIED_GHAST = register("dried_ghast", DriedGhastBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instabreak().sound(SoundEffectType.DRIED_GHAST).noOcclusion().randomTicks());
    ...
    public static final Block DEAD_TUBE_CORAL = register("dead_tube_coral", BlockCoralDead::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_BRAIN_CORAL = register("dead_brain_coral", BlockCoralDead::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_BUBBLE_CORAL = register("dead_bubble_coral", BlockCoralDead::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_FIRE_CORAL = register("dead_fire_coral", BlockCoralDead::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_HORN_CORAL = register("dead_horn_coral", BlockCoralDead::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLUE).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PINK).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PURPLE).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_RED).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block DEAD_TUBE_CORAL_FAN = register("dead_tube_coral_fan", BlockCoralFanAbstract::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_BRAIN_CORAL_FAN = register("dead_brain_coral_fan", BlockCoralFanAbstract::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_BUBBLE_CORAL_FAN = register("dead_bubble_coral_fan", BlockCoralFanAbstract::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_FIRE_CORAL_FAN = register("dead_fire_coral_fan", BlockCoralFanAbstract::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_HORN_CORAL_FAN = register("dead_horn_coral_fan", BlockCoralFanAbstract::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    ...
    public static final Block DEAD_TUBE_CORAL_WALL_FAN = register("dead_tube_coral_wall_fan", BlockCoralFanWallAbstract::new, wallVariant(Blocks.DEAD_TUBE_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_BRAIN_CORAL_WALL_FAN = register("dead_brain_coral_wall_fan", BlockCoralFanWallAbstract::new, wallVariant(Blocks.DEAD_BRAIN_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_BUBBLE_CORAL_WALL_FAN = register("dead_bubble_coral_wall_fan", BlockCoralFanWallAbstract::new, wallVariant(Blocks.DEAD_BUBBLE_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_FIRE_CORAL_WALL_FAN = register("dead_fire_coral_wall_fan", BlockCoralFanWallAbstract::new, wallVariant(Blocks.DEAD_FIRE_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    public static final Block DEAD_HORN_CORAL_WALL_FAN = register("dead_horn_coral_wall_fan", BlockCoralFanWallAbstract::new, wallVariant(Blocks.DEAD_HORN_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_GRAY).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollision().instabreak());
    ...
    }, wallVariant(Blocks.TUBE_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_BLUE).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, wallVariant(Blocks.BRAIN_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_PINK).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, wallVariant(Blocks.BUBBLE_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_PURPLE).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, wallVariant(Blocks.FIRE_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_RED).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, wallVariant(Blocks.HORN_CORAL_FAN, false).mapColor(MaterialMapColor.COLOR_YELLOW).noCollision().instabreak().sound(SoundEffectType.WET_GRASS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block VOID_AIR = register("void_air", BlockAir::new, BlockBase.Info.of().replaceable().noCollision().noLootTable().air());
    public static final Block CAVE_AIR = register("cave_air", BlockAir::new, BlockBase.Info.of().replaceable().noCollision().noLootTable().air());
    public static final Block BUBBLE_COLUMN = register("bubble_column", BlockBubbleColumn::new, BlockBase.Info.of().mapColor(MaterialMapColor.WATER).replaceable().noCollision().noLootTable().pushReaction(EnumPistonReaction.DESTROY).liquid().sound(SoundEffectType.EMPTY));
    ...
    public static final Block SCAFFOLDING = register("scaffolding", BlockScaffolding::new, BlockBase.Info.of().mapColor(MaterialMapColor.SAND).noCollision().sound(SoundEffectType.SCAFFOLDING).dynamicShape().isValidSpawn(Blocks::never).pushReaction(EnumPistonReaction.DESTROY).isRedstoneConductor(Blocks::never));
    ...
    public static final Block FLETCHING_TABLE = register("fletching_table", BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).strength(2.5F).sound(SoundEffectType.WOOD).ignitedByLava());
    ...
    public static final WeatheringCopperBlocks COPPER_LANTERN = WeatheringCopperBlocks.create("copper_lantern", Blocks::register, BlockLantern::new, WeatheringLanternBlock::new, (weatheringcopper_a) -> {
        return BlockBase.Info.of().mapColor(MaterialMapColor.METAL).forceSolidOn().strength(3.5F).sound(SoundEffectType.LANTERN).lightLevel((iblockdata) -> {
            return 15;
        }).noOcclusion().pushReaction(EnumPistonReaction.DESTROY);
    });
    ...
    public static final Block SWEET_BERRY_BUSH = register("sweet_berry_bush", BlockSweetBerryBush::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).randomTicks().noCollision().sound(SoundEffectType.SWEET_BERRY_BUSH).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_CYAN).instabreak().noCollision().sound(SoundEffectType.FUNGUS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block WARPED_ROOTS = register("warped_roots", BlockRoots::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_CYAN).replaceable().noCollision().instabreak().sound(SoundEffectType.ROOTS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block NETHER_SPROUTS = register("nether_sprouts", BlockNetherSprouts::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_CYAN).replaceable().noCollision().instabreak().sound(SoundEffectType.NETHER_SPROUTS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.NETHER).instabreak().noCollision().sound(SoundEffectType.FUNGUS).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block WEEPING_VINES = register("weeping_vines", BlockWeepingVines::new, BlockBase.Info.of().mapColor(MaterialMapColor.NETHER).randomTicks().noCollision().instabreak().sound(SoundEffectType.WEEPING_VINES).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block WEEPING_VINES_PLANT = register("weeping_vines_plant", BlockWeepingVinesPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.NETHER).noCollision().instabreak().sound(SoundEffectType.WEEPING_VINES).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block TWISTING_VINES = register("twisting_vines", BlockTwistingVines::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_CYAN).randomTicks().noCollision().instabreak().sound(SoundEffectType.WEEPING_VINES).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block TWISTING_VINES_PLANT = register("twisting_vines_plant", BlockTwistingVinesPlant::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_CYAN).noCollision().instabreak().sound(SoundEffectType.WEEPING_VINES).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block CRIMSON_ROOTS = register("crimson_roots", BlockRoots::new, BlockBase.Info.of().mapColor(MaterialMapColor.NETHER).replaceable().noCollision().instabreak().sound(SoundEffectType.ROOTS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollision().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollision().strength(1.0F));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollision().strength(1.0F));
    ...
    }, wallVariant(Blocks.CRIMSON_SIGN, true).mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollision().strength(1.0F));
    ...
    }, wallVariant(Blocks.WARPED_SIGN, true).mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollision().strength(1.0F));
    ...
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLACK).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).noCollision().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block SCULK_VEIN = register("sculk_vein", SculkVeinBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLACK).forceSolidOn().noCollision().strength(0.2F).sound(SoundEffectType.SCULK_VEIN).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block COPPER_CHEST = register("copper_chest", (blockbase_info) -> {
        return new WeatheringCopperChestBlock(WeatheringCopper.a.UNAFFECTED, SoundEffects.COPPER_CHEST_OPEN, SoundEffects.COPPER_CHEST_CLOSE, blockbase_info);
    }, BlockBase.Info.of().mapColor(Blocks.COPPER_BLOCK.defaultMapColor()).strength(3.0F, 6.0F).sound(SoundEffectType.COPPER).requiresCorrectToolForDrops());
    public static final Block EXPOSED_COPPER_CHEST = register("exposed_copper_chest", (blockbase_info) -> {
        return new WeatheringCopperChestBlock(WeatheringCopper.a.EXPOSED, SoundEffects.COPPER_CHEST_OPEN, SoundEffects.COPPER_CHEST_CLOSE, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_CHEST).mapColor(MaterialMapColor.TERRACOTTA_LIGHT_GRAY));
    public static final Block WEATHERED_COPPER_CHEST = register("weathered_copper_chest", (blockbase_info) -> {
        return new WeatheringCopperChestBlock(WeatheringCopper.a.WEATHERED, SoundEffects.COPPER_CHEST_WEATHERED_OPEN, SoundEffects.COPPER_CHEST_WEATHERED_CLOSE, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_CHEST).mapColor(MaterialMapColor.WARPED_STEM));
    public static final Block OXIDIZED_COPPER_CHEST = register("oxidized_copper_chest", (blockbase_info) -> {
        return new WeatheringCopperChestBlock(WeatheringCopper.a.OXIDIZED, SoundEffects.COPPER_CHEST_OXIDIZED_OPEN, SoundEffects.COPPER_CHEST_OXIDIZED_CLOSE, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_CHEST).mapColor(MaterialMapColor.WARPED_NYLIUM));
    public static final Block WAXED_COPPER_CHEST = register("waxed_copper_chest", (blockbase_info) -> {
        return new CopperChestBlock(WeatheringCopper.a.UNAFFECTED, SoundEffects.COPPER_CHEST_OPEN, SoundEffects.COPPER_CHEST_CLOSE, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_CHEST));
    public static final Block WAXED_EXPOSED_COPPER_CHEST = register("waxed_exposed_copper_chest", (blockbase_info) -> {
        return new CopperChestBlock(WeatheringCopper.a.EXPOSED, SoundEffects.COPPER_CHEST_OPEN, SoundEffects.COPPER_CHEST_CLOSE, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.EXPOSED_COPPER_CHEST));
    public static final Block WAXED_WEATHERED_COPPER_CHEST = register("waxed_weathered_copper_chest", (blockbase_info) -> {
        return new CopperChestBlock(WeatheringCopper.a.WEATHERED, SoundEffects.COPPER_CHEST_WEATHERED_OPEN, SoundEffects.COPPER_CHEST_WEATHERED_CLOSE, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.WEATHERED_COPPER_CHEST));
    public static final Block WAXED_OXIDIZED_COPPER_CHEST = register("waxed_oxidized_copper_chest", (blockbase_info) -> {
        return new CopperChestBlock(WeatheringCopper.a.OXIDIZED, SoundEffects.COPPER_CHEST_OXIDIZED_OPEN, SoundEffects.COPPER_CHEST_OXIDIZED_CLOSE, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.OXIDIZED_COPPER_CHEST));
    public static final Block COPPER_GOLEM_STATUE = register("copper_golem_statue", (blockbase_info) -> {
        return new WeatheringCopperGolemStatueBlock(WeatheringCopper.a.UNAFFECTED, blockbase_info);
    }, BlockBase.Info.of().mapColor(Blocks.COPPER_BLOCK.defaultMapColor()).strength(3.0F, 6.0F).sound(SoundEffectType.COPPER_GOLEM_STATUE).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block EXPOSED_COPPER_GOLEM_STATUE = register("exposed_copper_golem_statue", (blockbase_info) -> {
        return new WeatheringCopperGolemStatueBlock(WeatheringCopper.a.EXPOSED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_GOLEM_STATUE).mapColor(MaterialMapColor.TERRACOTTA_LIGHT_GRAY));
    public static final Block WEATHERED_COPPER_GOLEM_STATUE = register("weathered_copper_golem_statue", (blockbase_info) -> {
        return new WeatheringCopperGolemStatueBlock(WeatheringCopper.a.WEATHERED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_GOLEM_STATUE).mapColor(MaterialMapColor.WARPED_STEM));
    public static final Block OXIDIZED_COPPER_GOLEM_STATUE = register("oxidized_copper_golem_statue", (blockbase_info) -> {
        return new WeatheringCopperGolemStatueBlock(WeatheringCopper.a.OXIDIZED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_GOLEM_STATUE).mapColor(MaterialMapColor.WARPED_NYLIUM));
    public static final Block WAXED_COPPER_GOLEM_STATUE = register("waxed_copper_golem_statue", (blockbase_info) -> {
        return new CopperGolemStatueBlock(WeatheringCopper.a.UNAFFECTED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.COPPER_GOLEM_STATUE));
    public static final Block WAXED_EXPOSED_COPPER_GOLEM_STATUE = register("waxed_exposed_copper_golem_statue", (blockbase_info) -> {
        return new CopperGolemStatueBlock(WeatheringCopper.a.EXPOSED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.EXPOSED_COPPER_GOLEM_STATUE));
    public static final Block WAXED_WEATHERED_COPPER_GOLEM_STATUE = register("waxed_weathered_copper_golem_statue", (blockbase_info) -> {
        return new CopperGolemStatueBlock(WeatheringCopper.a.WEATHERED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.WEATHERED_COPPER_GOLEM_STATUE));
    public static final Block WAXED_OXIDIZED_COPPER_GOLEM_STATUE = register("waxed_oxidized_copper_golem_statue", (blockbase_info) -> {
        return new CopperGolemStatueBlock(WeatheringCopper.a.OXIDIZED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.OXIDIZED_COPPER_GOLEM_STATUE));
    public static final Block LIGHTNING_ROD = register("lightning_rod", (blockbase_info) -> {
        return new WeatheringLightningRodBlock(WeatheringCopper.a.UNAFFECTED, blockbase_info);
    }, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER).noOcclusion());
    public static final Block EXPOSED_LIGHTNING_ROD = register("exposed_lightning_rod", (blockbase_info) -> {
        return new WeatheringLightningRodBlock(WeatheringCopper.a.EXPOSED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.LIGHTNING_ROD).mapColor(MaterialMapColor.TERRACOTTA_LIGHT_GRAY));
    public static final Block WEATHERED_LIGHTNING_ROD = register("weathered_lightning_rod", (blockbase_info) -> {
        return new WeatheringLightningRodBlock(WeatheringCopper.a.WEATHERED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.LIGHTNING_ROD).mapColor(MaterialMapColor.WARPED_STEM));
    public static final Block OXIDIZED_LIGHTNING_ROD = register("oxidized_lightning_rod", (blockbase_info) -> {
        return new WeatheringLightningRodBlock(WeatheringCopper.a.OXIDIZED, blockbase_info);
    }, BlockBase.Info.ofFullCopy(Blocks.LIGHTNING_ROD).mapColor(MaterialMapColor.WARPED_NYLIUM));
    public static final Block WAXED_LIGHTNING_ROD = register("waxed_lightning_rod", LightningRodBlock::new, BlockBase.Info.ofFullCopy(Blocks.LIGHTNING_ROD));
    public static final Block WAXED_EXPOSED_LIGHTNING_ROD = register("waxed_exposed_lightning_rod", LightningRodBlock::new, BlockBase.Info.ofFullCopy(Blocks.EXPOSED_LIGHTNING_ROD));
    public static final Block WAXED_WEATHERED_LIGHTNING_ROD = register("waxed_weathered_lightning_rod", LightningRodBlock::new, BlockBase.Info.ofFullCopy(Blocks.WEATHERED_LIGHTNING_ROD));
    public static final Block WAXED_OXIDIZED_LIGHTNING_ROD = register("waxed_oxidized_lightning_rod", LightningRodBlock::new, BlockBase.Info.ofFullCopy(Blocks.OXIDIZED_LIGHTNING_ROD));
    ...
    public static final Block CAVE_VINES = register("cave_vines", CaveVinesBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).randomTicks().noCollision().lightLevel(CaveVines.emission(14)).instabreak().sound(SoundEffectType.CAVE_VINES).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block CAVE_VINES_PLANT = register("cave_vines_plant", CaveVinesPlantBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().lightLevel(CaveVines.emission(14)).instabreak().sound(SoundEffectType.CAVE_VINES).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block SPORE_BLOSSOM = register("spore_blossom", SporeBlossomBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).instabreak().noCollision().sound(SoundEffectType.SPORE_BLOSSOM).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block PINK_PETALS = register("pink_petals", FlowerBedBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().sound(SoundEffectType.PINK_PETALS).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block WILDFLOWERS = register("wildflowers", FlowerBedBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().sound(SoundEffectType.PINK_PETALS).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block LEAF_LITTER = register("leaf_litter", LeafLitterBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BROWN).replaceable().noCollision().sound(SoundEffectType.LEAF_LITTER).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block BIG_DRIPLEAF_STEM = register("big_dripleaf_stem", BigDripleafStemBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().strength(0.1F).sound(SoundEffectType.BIG_DRIPLEAF).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block SMALL_DRIPLEAF = register("small_dripleaf", SmallDripleafBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollision().instabreak().sound(SoundEffectType.SMALL_DRIPLEAF).offsetType(BlockBase.EnumRandomOffset.XYZ).pushReaction(EnumPistonReaction.DESTROY));
    public static final Block HANGING_ROOTS = register("hanging_roots", HangingRootsBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.DIRT).replaceable().noCollision().instabreak().sound(SoundEffectType.HANGING_ROOTS).offsetType(BlockBase.EnumRandomOffset.XZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block FROGSPAWN = register("frogspawn", FrogspawnBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.WATER).instabreak().noOcclusion().noCollision().sound(SoundEffectType.FROGSPAWN).pushReaction(EnumPistonReaction.DESTROY));
    ...
    public static final Block PALE_HANGING_MOSS = register("pale_hanging_moss", HangingMossBlock::new, BlockBase.Info.of().ignitedByLava().mapColor(Blocks.PALE_MOSS_BLOCK.defaultMapColor()).noCollision().sound(SoundEffectType.MOSS_CARPET).pushReaction(EnumPistonReaction.DESTROY));
    ...
    }, BlockBase.Info.of().mapColor(Blocks.CREAKING_HEART.defaultMapColor()).noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY).randomTicks());
    ...
    }, BlockBase.Info.of().mapColor(Blocks.PALE_OAK_LEAVES.defaultMapColor()).noCollision().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY).randomTicks());
    ...
    public static final Block FIREFLY_BUSH = register("firefly_bush", FireflyBushBlock::new, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).ignitedByLava().lightLevel((iblockdata) -> {
        return 2;
    }).noCollision().instabreak().sound(SoundEffectType.SWEET_BERRY_BUSH).pushReaction(EnumPistonReaction.DESTROY));
