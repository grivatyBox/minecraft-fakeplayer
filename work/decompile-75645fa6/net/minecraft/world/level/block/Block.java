...
public class Block extends BlockBase implements IMaterial {
    ...
    protected static boolean dropFromBlockInteractLootTable(WorldServer worldserver, ResourceKey<LootTable> resourcekey, IBlockData iblockdata, @Nullable TileEntity tileentity, @Nullable ItemStack itemstack, @Nullable Entity entity, BiConsumer<WorldServer, ItemStack> biconsumer) {
        return dropFromLootTable(worldserver, resourcekey, (lootparams_a) -> {
            return lootparams_a.withParameter(LootContextParameters.BLOCK_STATE, iblockdata).withOptionalParameter(LootContextParameters.BLOCK_ENTITY, tileentity).withOptionalParameter(LootContextParameters.INTERACTING_ENTITY, entity).withOptionalParameter(LootContextParameters.TOOL, itemstack).create(LootContextParameterSets.BLOCK_INTERACT);
        }, biconsumer);
    }

    protected static boolean dropFromLootTable(WorldServer worldserver, ResourceKey<LootTable> resourcekey, Function<LootParams.a, LootParams> function, BiConsumer<WorldServer, ItemStack> biconsumer) {
