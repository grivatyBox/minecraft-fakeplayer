...
public class CollectingNeighborUpdater implements NeighborUpdater {
    ...
    private int count = 0;
    @Nullable
    private Consumer<BlockPosition> debugListener;
    ...
    public void setDebugListener(@Nullable Consumer<BlockPosition> consumer) {
        ...
        try {
            while (!this.stack.isEmpty() || !this.addedThisLayer.isEmpty()) {
                ...
                if (this.debugListener != null) {
                    collectingneighborupdater_c.forEachUpdatedPos(this.debugListener);
                }
    ...
    static record e(BlockPosition pos, Block block, @Nullable Orientation orientation) implements CollectingNeighborUpdater.c {
        ...
        @Override
        public void forEachUpdatedPos(Consumer<BlockPosition> consumer) {
    ...
    static final class b implements CollectingNeighborUpdater.c {
        ...
        @Override
        public void forEachUpdatedPos(Consumer<BlockPosition> consumer) {
            for (EnumDirection enumdirection : NeighborUpdater.UPDATE_ORDER) {
                if (enumdirection != this.skipDirection) {
                    BlockPosition blockposition = this.sourcePos.relative(enumdirection);
    ...
    private interface c {
        ...
        void forEachUpdatedPos(Consumer<BlockPosition> consumer);
    }
}
