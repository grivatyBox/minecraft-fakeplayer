...
public final class OverworldBiomeBuilder {
    ...
    private void addDebugBiomes(Consumer<Pair<Climate.d, ResourceKey<BiomeBase>>> consumer) {
        HolderLookup.a holderlookup_a = (new RegistrySetBuilder()).add(Registries.DENSITY_FUNCTION, NoiseRouterData::bootstrap).add(Registries.NOISE, NoiseData::bootstrap).build(IRegistryCustom.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY));
        HolderGetter<DensityFunction> holdergetter = holderlookup_a.lookupOrThrow(Registries.DENSITY_FUNCTION);
        DensityFunctions.x.a densityfunctions_x_a = new DensityFunctions.x.a(holdergetter.getOrThrow(NoiseRouterData.CONTINENTS));
        DensityFunctions.x.a densityfunctions_x_a1 = new DensityFunctions.x.a(holdergetter.getOrThrow(NoiseRouterData.EROSION));
        DensityFunctions.x.a densityfunctions_x_a2 = new DensityFunctions.x.a(holdergetter.getOrThrow(NoiseRouterData.RIDGES_FOLDED));
        ...
        CubicSpline<?, ?> cubicspline = TerrainProvider.buildErosionOffsetSpline(densityfunctions_x_a1, densityfunctions_x_a2, -0.15F, 0.0F, 0.0F, 0.1F, 0.0F, -0.03F, false, false, BoundedFloatFunction.IDENTITY);
        ...
        CubicSpline<?, ?> cubicspline1 = TerrainProvider.overworldOffset(densityfunctions_x_a, densityfunctions_x_a1, densityfunctions_x_a2, false);
