...
public class EuclideanGameEventListenerRegistry implements GameEventListenerRegistry {
    ...
    private static void sendDebugInfo(WorldServer worldserver, GameEventListener gameeventlistener) {
        if (worldserver.debugSynchronizers().hasAnySubscriberFor(DebugSubscriptions.GAME_EVENT_LISTENERS)) {
            ...
            if (positionsource instanceof BlockPositionSource) {
                ...
                worldserver.debugSynchronizers().sendBlockValue(blockpositionsource.pos(), DebugSubscriptions.GAME_EVENT_LISTENERS, debuggameeventlistenerinfo);
                ...
                Entity entity = worldserver.getEntity(entitypositionsource.getUuid());

                if (entity != null) {
                    worldserver.debugSynchronizers().sendEntityValue(entity, DebugSubscriptions.GAME_EVENT_LISTENERS, debuggameeventlistenerinfo);
                }
            }
