...
public final class JigsawStructure extends Structure {
    ...
    public static final MapCodec<JigsawStructure> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        ...
        }), JigsawStructure.a.CODEC.fieldOf("max_distance_from_center").forGetter((jigsawstructure) -> {
    ...
    private final JigsawStructure.a maxDistanceFromCenter;
    ...
    public JigsawStructure(Structure.c structure_c, Holder<WorldGenFeatureDefinedStructurePoolTemplate> holder, Optional<MinecraftKey> optional, int i, HeightProvider heightprovider, boolean flag, Optional<HeightMap.Type> optional1, JigsawStructure.a jigsawstructure_a, List<PoolAliasBinding> list, DimensionPadding dimensionpadding, LiquidSettings liquidsettings) {
        ...
        this.maxDistanceFromCenter = jigsawstructure_a;
    ...
    public JigsawStructure(Structure.c structure_c, Holder<WorldGenFeatureDefinedStructurePoolTemplate> holder, int i, HeightProvider heightprovider, boolean flag, HeightMap.Type heightmap_type) {
        this(structure_c, holder, Optional.empty(), i, heightprovider, flag, Optional.of(heightmap_type), new JigsawStructure.a(80), List.of(), JigsawStructure.DEFAULT_DIMENSION_PADDING, JigsawStructure.DEFAULT_LIQUID_SETTINGS);
    }
    ...
    public JigsawStructure(Structure.c structure_c, Holder<WorldGenFeatureDefinedStructurePoolTemplate> holder, int i, HeightProvider heightprovider, boolean flag) {
        this(structure_c, holder, Optional.empty(), i, heightprovider, flag, Optional.empty(), new JigsawStructure.a(80), List.of(), JigsawStructure.DEFAULT_DIMENSION_PADDING, JigsawStructure.DEFAULT_LIQUID_SETTINGS);
    }
    ...
    public static record a(int horizontal, int vertical) {

        private static final Codec<Integer> HORIZONTAL_VALUE_CODEC = Codec.intRange(1, 128);
        private static final Codec<JigsawStructure.a> FULL_CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(JigsawStructure.a.HORIZONTAL_VALUE_CODEC.fieldOf("horizontal").forGetter(JigsawStructure.a::horizontal), ExtraCodecs.intRange(1, DimensionManager.Y_SIZE).optionalFieldOf("vertical", DimensionManager.Y_SIZE).forGetter(JigsawStructure.a::vertical)).apply(instance, JigsawStructure.a::new);
        });
        public static final Codec<JigsawStructure.a> CODEC = Codec.either(JigsawStructure.a.FULL_CODEC, JigsawStructure.a.HORIZONTAL_VALUE_CODEC).xmap((either) -> {
            return (JigsawStructure.a) either.map(Function.identity(), JigsawStructure.a::new);
        }, (jigsawstructure_a) -> {
            return jigsawstructure_a.horizontal == jigsawstructure_a.vertical ? Either.right(jigsawstructure_a.horizontal) : Either.left(jigsawstructure_a);
        });
