                        ...
                        if (structureboundingbox == null || structureboundingbox.isInside(blockposition2)) {
                            ...
                            if (worldaccess.setBlock(blockposition2, iblockdata, i)) {
                                ...
                                if (definedstructure_blockinfo.nbt != null) {
                                    ...
                                    if (tileentity != null) {
                                        if (!SharedConstants.DEBUG_STRUCTURE_EDIT_MODE && tileentity instanceof RandomizableContainer) {
        ...
        for (DefinedStructure.EntityInfo definedstructure_entityinfo : this.entityInfoList) {
            ...
            if (structureboundingbox == null || structureboundingbox.isInside(blockposition2)) {
                ...
                createEntityIgnoreException(problemreporter, worldaccess, nbttagcompound).ifPresent((entity) -> {
                    ...
                    if (flag && entity instanceof EntityInsentient entityinsentient) {
                        entityinsentient.finalizeSpawn(worldaccess, worldaccess.getCurrentDifficultyAt(BlockPosition.containing(vec3d1)), EntitySpawnReason.STRUCTURE, (GroupDataEntity) null);
                    }
