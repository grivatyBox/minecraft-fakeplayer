...
public class StructureBoundingBox {
    ...
    public static final StreamCodec<ByteBuf, StructureBoundingBox> STREAM_CODEC = StreamCodec.composite(BlockPosition.STREAM_CODEC, (structureboundingbox) -> {
        return new BlockPosition(structureboundingbox.minX, structureboundingbox.minY, structureboundingbox.minZ);
    }, BlockPosition.STREAM_CODEC, (structureboundingbox) -> {
        return new BlockPosition(structureboundingbox.maxX, structureboundingbox.maxY, structureboundingbox.maxZ);
    }, (blockposition, blockposition1) -> {
        return new StructureBoundingBox(blockposition.getX(), blockposition.getY(), blockposition.getZ(), blockposition1.getX(), blockposition1.getY(), blockposition1.getZ());
    });
    private int minX;
    private int minY;
    private int minZ;
    ...
    public static StructureBoundingBox encapsulating(StructureBoundingBox structureboundingbox, StructureBoundingBox structureboundingbox1) {
        return new StructureBoundingBox(Math.min(structureboundingbox.minX, structureboundingbox1.minX), Math.min(structureboundingbox.minY, structureboundingbox1.minY), Math.min(structureboundingbox.minZ, structureboundingbox1.minZ), Math.max(structureboundingbox.maxX, structureboundingbox1.maxX), Math.max(structureboundingbox.maxY, structureboundingbox1.maxY), Math.max(structureboundingbox.maxZ, structureboundingbox1.maxZ));
    }
