...
public interface Spawner {
    ...
    static void appendHoverText(@Nullable TypedEntityData<TileEntityTypes<?>> typedentitydata, Consumer<IChatBaseComponent> consumer, String s) {
        IChatBaseComponent ichatbasecomponent = getSpawnEntityDisplayName(typedentitydata, s);
    ...
    @Nullable
    static IChatBaseComponent getSpawnEntityDisplayName(@Nullable TypedEntityData<TileEntityTypes<?>> typedentitydata, String s) {
        return typedentitydata == null ? null : (IChatBaseComponent) typedentitydata.getUnsafe().getCompound(s).flatMap((nbttagcompound) -> {
