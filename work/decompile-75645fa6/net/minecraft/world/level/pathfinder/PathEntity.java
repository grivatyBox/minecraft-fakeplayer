...
public final class PathEntity {
    ...
    public static final StreamCodec<PacketDataSerializer, PathEntity> STREAM_CODEC = StreamCodec.<PacketDataSerializer, PathEntity>of((packetdataserializer, pathentity) -> {
        pathentity.writeToStream(packetdataserializer);
    }, PathEntity::createFromStream);
    ...
    public boolean equals(Object object) {
        if (!(object instanceof PathEntity pathentity)) {
            return false;
        } else {
            return this.nextNodeIndex == pathentity.nextNodeIndex && this.debugData == pathentity.debugData && this.reached == pathentity.reached && this.target.equals(pathentity.target) && this.nodes.equals(pathentity.nodes);
        }
    }
