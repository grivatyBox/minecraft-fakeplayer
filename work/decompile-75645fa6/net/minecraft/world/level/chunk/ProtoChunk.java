...
public class ProtoChunk extends IChunkAccess {
    ...
    public ProtoChunk(ChunkCoordIntPair chunkcoordintpair, ChunkConverter chunkconverter, LevelHeightAccessor levelheightaccessor, PalettedContainerFactory palettedcontainerfactory, @Nullable BlendingData blendingdata) {
        this(chunkcoordintpair, chunkconverter, (ChunkSection[]) null, new ProtoChunkTickList(), new ProtoChunkTickList(), levelheightaccessor, palettedcontainerfactory, blendingdata);
    }

    public ProtoChunk(ChunkCoordIntPair chunkcoordintpair, ChunkConverter chunkconverter, @Nullable ChunkSection[] achunksection, ProtoChunkTickList<Block> protochunkticklist, ProtoChunkTickList<FluidType> protochunkticklist1, LevelHeightAccessor levelheightaccessor, PalettedContainerFactory palettedcontainerfactory, @Nullable BlendingData blendingdata) {
        super(chunkcoordintpair, chunkconverter, levelheightaccessor, palettedcontainerfactory, 0L, achunksection, blendingdata);
    ...
    public void addEntity(Entity entity) {
        if (!entity.isPassenger()) {
            try (ProblemReporter.j problemreporter_j = new ProblemReporter.j(entity.problemPath(), ProtoChunk.LOGGER)) {
