...
public abstract class LootEntryChildrenAbstract extends LootEntryAbstract {
    ...
    public void validate(LootCollector lootcollector) {
        ...
        if (this.children.isEmpty()) {
            lootcollector.reportProblem(LootEntryChildrenAbstract.NO_CHILDREN_PROBLEM);
        }

        for (int i = 0; i < this.children.size(); ++i) {
            ((LootEntryAbstract) this.children.get(i)).validate(lootcollector.forChild(new ProblemReporter.d("children", i)));
        }
