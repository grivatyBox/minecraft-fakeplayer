...
public class NbtProviders {
    ...
    private static LootNbtProviderType register(String s, MapCodec<? extends NbtProvider> mapcodec) {
        return (LootNbtProviderType) IRegistry.register(BuiltInRegistries.LOOT_NBT_PROVIDER_TYPE, MinecraftKey.withDefaultNamespace(s), new LootNbtProviderType(mapcodec));
    }
}
