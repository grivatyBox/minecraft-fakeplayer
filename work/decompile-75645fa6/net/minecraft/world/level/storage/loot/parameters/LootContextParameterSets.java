...
public class LootContextParameterSets {
    ...
    static {
        ...
        ENTITY_INTERACT = register("entity_interact", (contextkeyset_a) -> {
            contextkeyset_a.required(LootContextParameters.TARGET_ENTITY).optional(LootContextParameters.INTERACTING_ENTITY).required(LootContextParameters.TOOL);
        });
        BLOCK_INTERACT = register("block_interact", (contextkeyset_a) -> {
            contextkeyset_a.required(LootContextParameters.BLOCK_STATE).optional(LootContextParameters.BLOCK_ENTITY).optional(LootContextParameters.INTERACTING_ENTITY).optional(LootContextParameters.TOOL);
        });
