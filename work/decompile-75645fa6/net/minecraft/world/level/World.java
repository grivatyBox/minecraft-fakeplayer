...
public abstract class World implements GeneratorAccess, AutoCloseable {
    ...
    public static final WeightedList<ExplosionParticleInfo> DEFAULT_EXPLOSION_BLOCK_PARTICLES = WeightedList.<ExplosionParticleInfo>builder().add(new ExplosionParticleInfo(Particles.POOF, 0.5F, 1.0F)).add(new ExplosionParticleInfo(Particles.SMOKE, 1.0F, 1.0F)).build();
    ...
    protected World(WorldDataMutable worlddatamutable, ResourceKey<World> resourcekey, IRegistryCustom iregistrycustom, Holder<DimensionManager> holder, boolean flag, boolean flag1, long i, int j) {
        ...
        this.palettedContainerFactory = PalettedContainerFactory.create(iregistrycustom);
    ...
    public void explode(@Nullable Entity entity, double d0, double d1, double d2, float f, World.a world_a) {
        this.explode(entity, Explosion.getDefaultDamageSource(this, entity), (ExplosionDamageCalculator) null, d0, d1, d2, f, false, world_a, Particles.EXPLOSION, Particles.EXPLOSION_EMITTER, World.DEFAULT_EXPLOSION_BLOCK_PARTICLES, SoundEffects.GENERIC_EXPLODE);
    }

    public void explode(@Nullable Entity entity, double d0, double d1, double d2, float f, boolean flag, World.a world_a) {
        this.explode(entity, Explosion.getDefaultDamageSource(this, entity), (ExplosionDamageCalculator) null, d0, d1, d2, f, flag, world_a, Particles.EXPLOSION, Particles.EXPLOSION_EMITTER, World.DEFAULT_EXPLOSION_BLOCK_PARTICLES, SoundEffects.GENERIC_EXPLODE);
    }
    ...
    public void explode(@Nullable Entity entity, @Nullable DamageSource damagesource, @Nullable ExplosionDamageCalculator explosiondamagecalculator, Vec3D vec3d, float f, boolean flag, World.a world_a) {
        this.explode(entity, damagesource, explosiondamagecalculator, vec3d.x(), vec3d.y(), vec3d.z(), f, flag, world_a, Particles.EXPLOSION, Particles.EXPLOSION_EMITTER, World.DEFAULT_EXPLOSION_BLOCK_PARTICLES, SoundEffects.GENERIC_EXPLODE);
    }
    ...
    public void explode(@Nullable Entity entity, @Nullable DamageSource damagesource, @Nullable ExplosionDamageCalculator explosiondamagecalculator, double d0, double d1, double d2, float f, boolean flag, World.a world_a) {
        this.explode(entity, damagesource, explosiondamagecalculator, d0, d1, d2, f, flag, world_a, Particles.EXPLOSION, Particles.EXPLOSION_EMITTER, World.DEFAULT_EXPLOSION_BLOCK_PARTICLES, SoundEffects.GENERIC_EXPLODE);
    }

    public abstract void explode(@Nullable Entity entity, @Nullable DamageSource damagesource, @Nullable ExplosionDamageCalculator explosiondamagecalculator, double d0, double d1, double d2, float f, boolean flag, World.a world_a, ParticleParam particleparam, ParticleParam particleparam1, WeightedList<ExplosionParticleInfo> weightedlist, Holder<SoundEffect> holder);
    ...
    public abstract void setRespawnData(WorldData.a worlddata_a);

    public abstract WorldData.a getRespawnData();

    public WorldData.a getWorldBorderAdjustedRespawnData(WorldData.a worlddata_a) {
        WorldBorder worldborder = this.getWorldBorder();

        if (!worldborder.isWithinBounds(worlddata_a.pos())) {
            BlockPosition blockposition = this.getHeightmapPos(HeightMap.Type.MOTION_BLOCKING, BlockPosition.containing(worldborder.getCenterX(), 0.0D, worldborder.getCenterZ()));

            return WorldData.a.of(worlddata_a.dimension(), blockposition, worlddata_a.yaw(), worlddata_a.pitch());
        } else {
            return worlddata_a;
        }
    }
    ...
    public <T extends Entity> boolean hasEntities(EntityTypeTest<Entity, T> entitytypetest, AxisAlignedBB axisalignedbb, Predicate<? super T> predicate) {
    ...
    @Nullable
    public EntityHuman getPlayerInAnyDimension(UUID uuid) {
