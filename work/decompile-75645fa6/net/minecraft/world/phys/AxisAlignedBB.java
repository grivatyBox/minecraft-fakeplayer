...
public class AxisAlignedBB {
    ...
    public boolean intersects(BlockPosition blockposition) {
        return this.intersects((double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ(), (double) (blockposition.getX() + 1), (double) (blockposition.getY() + 1), (double) (blockposition.getZ() + 1));
    }
    ...
    public boolean collidedAlongVector(Vec3D vec3d, List<AxisAlignedBB> list) {
        ...
        for (AxisAlignedBB axisalignedbb : list) {
            AxisAlignedBB axisalignedbb1 = axisalignedbb.inflate(this.getXsize() * 0.5D - 1.0E-7D, this.getYsize() * 0.5D - 1.0E-7D, this.getZsize() * 0.5D - 1.0E-7D);
    ...
    public double distanceToSqr(AxisAlignedBB axisalignedbb) {
        double d0 = Math.max(Math.max(this.minX - axisalignedbb.maxX, axisalignedbb.minX - this.maxX), 0.0D);
        double d1 = Math.max(Math.max(this.minY - axisalignedbb.maxY, axisalignedbb.minY - this.maxY), 0.0D);
        double d2 = Math.max(Math.max(this.minZ - axisalignedbb.maxZ, axisalignedbb.minZ - this.maxZ), 0.0D);
