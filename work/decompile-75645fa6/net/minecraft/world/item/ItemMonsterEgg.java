...
public class ItemMonsterEgg extends Item {
    ...
    public FeatureFlagSet requiredFeatures() {
        return (FeatureFlagSet) Optional.ofNullable((TypedEntityData) this.components().get(DataComponents.ENTITY_DATA)).map(TypedEntityData::type).map(EntityTypes::requiredFeatures).orElseGet(FeatureFlagSet::of);
    }
