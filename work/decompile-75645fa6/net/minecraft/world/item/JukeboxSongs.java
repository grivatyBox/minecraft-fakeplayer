...
public interface JukeboxSongs {
    ...
    static void bootstrap(BootstrapContext<JukeboxSong> bootstrapcontext) {
        ...
        register(bootstrapcontext, JukeboxSongs.TEARS, SoundEffects.MUSIC_DISC_TEARS, 175, 10);
        register(bootstrapcontext, JukeboxSongs.LAVA_CHICKEN, SoundEffects.MUSIC_DISC_LAVA_CHICKEN, 134, 9);
    }
}
