...
public final class ItemStack implements DataComponentHolder {
    ...
    public void hurtAndBreak(int i, EntityLiving entityliving, EnumHand enumhand) {
        this.hurtAndBreak(i, entityliving, enumhand.asEquipmentSlot());
    }
    ...
    public <T> T set(TypedDataComponent<T> typeddatacomponent) {
        return (T) this.components.set(typeddatacomponent);
    }
    ...
    public void addDetailsToTooltip(Item.b item_b, TooltipDisplay tooltipdisplay, @Nullable EntityHuman entityhuman, TooltipFlag tooltipflag, Consumer<IChatBaseComponent> consumer) {
        ...
        this.addToTooltip(DataComponents.PROFILE, item_b, tooltipdisplay, consumer, tooltipflag);
        ...
        this.addToTooltip(DataComponents.ENTITY_DATA, item_b, tooltipdisplay, consumer, tooltipflag);
        if ((this.is(Items.SPAWNER) || this.is(Items.TRIAL_SPAWNER)) && tooltipdisplay.shows(DataComponents.BLOCK_ENTITY_DATA)) {
            TypedEntityData<TileEntityTypes<?>> typedentitydata = (TypedEntityData) this.get(DataComponents.BLOCK_ENTITY_DATA);
