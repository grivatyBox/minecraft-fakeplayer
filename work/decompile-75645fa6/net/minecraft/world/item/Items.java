...
public class Items {
    ...
    public static final Item ACACIA_SHELF = registerBlock(Blocks.ACACIA_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item BAMBOO_SHELF = registerBlock(Blocks.BAMBOO_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item BIRCH_SHELF = registerBlock(Blocks.BIRCH_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item CHERRY_SHELF = registerBlock(Blocks.CHERRY_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item CRIMSON_SHELF = registerBlock(Blocks.CRIMSON_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item DARK_OAK_SHELF = registerBlock(Blocks.DARK_OAK_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item JUNGLE_SHELF = registerBlock(Blocks.JUNGLE_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item MANGROVE_SHELF = registerBlock(Blocks.MANGROVE_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item OAK_SHELF = registerBlock(Blocks.OAK_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item PALE_OAK_SHELF = registerBlock(Blocks.PALE_OAK_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item SPRUCE_SHELF = registerBlock(Blocks.SPRUCE_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item WARPED_SHELF = registerBlock(Blocks.WARPED_SHELF, (item_info) -> {
        return item_info.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    ...
    public static final Item CARVED_PUMPKIN = registerBlock(Blocks.CARVED_PUMPKIN, (item_info) -> {
        return Waypoint.addHideAttribute(item_info).component(DataComponents.EQUIPPABLE, Equippable.builder(EnumItemSlot.HEAD).setSwappable(false).setCameraOverlay(MinecraftKey.withDefaultNamespace("misc/pumpkinblur")).build());
    });
    ...
    public static final Item COPPER_TORCH = registerBlock(Blocks.COPPER_TORCH, (block, item_info) -> {
        return new ItemBlockWallable(block, Blocks.COPPER_WALL_TORCH, EnumDirection.DOWN, item_info);
    });
    ...
    public static final Item WHITE_HARNESS = registerItem("white_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.WHITE)));
    public static final Item ORANGE_HARNESS = registerItem("orange_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.ORANGE)));
    public static final Item MAGENTA_HARNESS = registerItem("magenta_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.MAGENTA)));
    public static final Item LIGHT_BLUE_HARNESS = registerItem("light_blue_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.LIGHT_BLUE)));
    public static final Item YELLOW_HARNESS = registerItem("yellow_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.YELLOW)));
    public static final Item LIME_HARNESS = registerItem("lime_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.LIME)));
    public static final Item PINK_HARNESS = registerItem("pink_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.PINK)));
    public static final Item GRAY_HARNESS = registerItem("gray_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.GRAY)));
    public static final Item LIGHT_GRAY_HARNESS = registerItem("light_gray_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.LIGHT_GRAY)));
    public static final Item CYAN_HARNESS = registerItem("cyan_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.CYAN)));
    public static final Item PURPLE_HARNESS = registerItem("purple_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.PURPLE)));
    public static final Item BLUE_HARNESS = registerItem("blue_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.BLUE)));
    public static final Item BROWN_HARNESS = registerItem("brown_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.BROWN)));
    public static final Item GREEN_HARNESS = registerItem("green_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.GREEN)));
    public static final Item RED_HARNESS = registerItem("red_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.RED)));
    public static final Item BLACK_HARNESS = registerItem("black_harness", (new Item.Info()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(EnumColor.BLACK)));
    ...
    public static final Item COPPER_SWORD = registerItem("copper_sword", (new Item.Info()).sword(ToolMaterial.COPPER, 3.0F, -2.4F));
    public static final Item COPPER_SHOVEL = registerItem("copper_shovel", (item_info) -> {
        return new ItemSpade(ToolMaterial.COPPER, 1.5F, -3.0F, item_info);
    });
    public static final Item COPPER_PICKAXE = registerItem("copper_pickaxe", (new Item.Info()).pickaxe(ToolMaterial.COPPER, 1.0F, -2.8F));
    public static final Item COPPER_AXE = registerItem("copper_axe", (item_info) -> {
        return new ItemAxe(ToolMaterial.COPPER, 7.0F, -3.2F, item_info);
    });
    public static final Item COPPER_HOE = registerItem("copper_hoe", (item_info) -> {
        return new ItemHoe(ToolMaterial.COPPER, -1.0F, -2.0F, item_info);
    });
    ...
    public static final Item COPPER_HELMET = registerItem("copper_helmet", (new Item.Info()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.HELMET));
    public static final Item COPPER_CHESTPLATE = registerItem("copper_chestplate", (new Item.Info()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.CHESTPLATE));
    public static final Item COPPER_LEGGINGS = registerItem("copper_leggings", (new Item.Info()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.LEGGINGS));
    public static final Item COPPER_BOOTS = registerItem("copper_boots", (new Item.Info()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.BOOTS));
    ...
    public static final Item ARMADILLO_SPAWN_EGG = registerItem("armadillo_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ARMADILLO));
    public static final Item ALLAY_SPAWN_EGG = registerItem("allay_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ALLAY));
    public static final Item AXOLOTL_SPAWN_EGG = registerItem("axolotl_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.AXOLOTL));
    public static final Item BAT_SPAWN_EGG = registerItem("bat_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.BAT));
    public static final Item BEE_SPAWN_EGG = registerItem("bee_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.BEE));
    public static final Item BLAZE_SPAWN_EGG = registerItem("blaze_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.BLAZE));
    public static final Item BOGGED_SPAWN_EGG = registerItem("bogged_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.BOGGED));
    public static final Item BREEZE_SPAWN_EGG = registerItem("breeze_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.BREEZE));
    public static final Item CAT_SPAWN_EGG = registerItem("cat_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.CAT));
    public static final Item CAMEL_SPAWN_EGG = registerItem("camel_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.CAMEL));
    public static final Item CAVE_SPIDER_SPAWN_EGG = registerItem("cave_spider_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.CAVE_SPIDER));
    public static final Item CHICKEN_SPAWN_EGG = registerItem("chicken_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.CHICKEN));
    public static final Item COD_SPAWN_EGG = registerItem("cod_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.COD));
    public static final Item COPPER_GOLEM_SPAWN_EGG = registerItem("copper_golem_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.COPPER_GOLEM));
    public static final Item COW_SPAWN_EGG = registerItem("cow_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.COW));
    public static final Item CREEPER_SPAWN_EGG = registerItem("creeper_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.CREEPER));
    public static final Item DOLPHIN_SPAWN_EGG = registerItem("dolphin_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.DOLPHIN));
    public static final Item DONKEY_SPAWN_EGG = registerItem("donkey_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.DONKEY));
    public static final Item DROWNED_SPAWN_EGG = registerItem("drowned_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.DROWNED));
    public static final Item ELDER_GUARDIAN_SPAWN_EGG = registerItem("elder_guardian_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ELDER_GUARDIAN));
    public static final Item ENDER_DRAGON_SPAWN_EGG = registerItem("ender_dragon_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ENDER_DRAGON));
    public static final Item ENDERMAN_SPAWN_EGG = registerItem("enderman_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ENDERMAN));
    public static final Item ENDERMITE_SPAWN_EGG = registerItem("endermite_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ENDERMITE));
    public static final Item EVOKER_SPAWN_EGG = registerItem("evoker_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.EVOKER));
    public static final Item FOX_SPAWN_EGG = registerItem("fox_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.FOX));
    public static final Item FROG_SPAWN_EGG = registerItem("frog_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.FROG));
    public static final Item GHAST_SPAWN_EGG = registerItem("ghast_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.GHAST));
    public static final Item HAPPY_GHAST_SPAWN_EGG = registerItem("happy_ghast_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.HAPPY_GHAST));
    public static final Item GLOW_SQUID_SPAWN_EGG = registerItem("glow_squid_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.GLOW_SQUID));
    public static final Item GOAT_SPAWN_EGG = registerItem("goat_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.GOAT));
    public static final Item GUARDIAN_SPAWN_EGG = registerItem("guardian_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.GUARDIAN));
    public static final Item HOGLIN_SPAWN_EGG = registerItem("hoglin_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.HOGLIN));
    public static final Item HORSE_SPAWN_EGG = registerItem("horse_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.HORSE));
    public static final Item HUSK_SPAWN_EGG = registerItem("husk_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.HUSK));
    public static final Item IRON_GOLEM_SPAWN_EGG = registerItem("iron_golem_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.IRON_GOLEM));
    public static final Item LLAMA_SPAWN_EGG = registerItem("llama_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.LLAMA));
    public static final Item MAGMA_CUBE_SPAWN_EGG = registerItem("magma_cube_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.MAGMA_CUBE));
    public static final Item MOOSHROOM_SPAWN_EGG = registerItem("mooshroom_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.MOOSHROOM));
    public static final Item MULE_SPAWN_EGG = registerItem("mule_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.MULE));
    public static final Item OCELOT_SPAWN_EGG = registerItem("ocelot_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.OCELOT));
    public static final Item PANDA_SPAWN_EGG = registerItem("panda_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PANDA));
    public static final Item PARROT_SPAWN_EGG = registerItem("parrot_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PARROT));
    public static final Item PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PHANTOM));
    public static final Item PIG_SPAWN_EGG = registerItem("pig_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PIG));
    public static final Item PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PIGLIN));
    public static final Item PIGLIN_BRUTE_SPAWN_EGG = registerItem("piglin_brute_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PIGLIN_BRUTE));
    public static final Item PILLAGER_SPAWN_EGG = registerItem("pillager_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PILLAGER));
    public static final Item POLAR_BEAR_SPAWN_EGG = registerItem("polar_bear_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.POLAR_BEAR));
    public static final Item PUFFERFISH_SPAWN_EGG = registerItem("pufferfish_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.PUFFERFISH));
    public static final Item RABBIT_SPAWN_EGG = registerItem("rabbit_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.RABBIT));
    public static final Item RAVAGER_SPAWN_EGG = registerItem("ravager_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.RAVAGER));
    public static final Item SALMON_SPAWN_EGG = registerItem("salmon_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SALMON));
    public static final Item SHEEP_SPAWN_EGG = registerItem("sheep_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SHEEP));
    public static final Item SHULKER_SPAWN_EGG = registerItem("shulker_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SHULKER));
    public static final Item SILVERFISH_SPAWN_EGG = registerItem("silverfish_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SILVERFISH));
    public static final Item SKELETON_SPAWN_EGG = registerItem("skeleton_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SKELETON));
    public static final Item SKELETON_HORSE_SPAWN_EGG = registerItem("skeleton_horse_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SKELETON_HORSE));
    public static final Item SLIME_SPAWN_EGG = registerItem("slime_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SLIME));
    public static final Item SNIFFER_SPAWN_EGG = registerItem("sniffer_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SNIFFER));
    public static final Item SNOW_GOLEM_SPAWN_EGG = registerItem("snow_golem_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SNOW_GOLEM));
    public static final Item SPIDER_SPAWN_EGG = registerItem("spider_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SPIDER));
    public static final Item SQUID_SPAWN_EGG = registerItem("squid_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.SQUID));
    public static final Item STRAY_SPAWN_EGG = registerItem("stray_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.STRAY));
    public static final Item STRIDER_SPAWN_EGG = registerItem("strider_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.STRIDER));
    public static final Item TADPOLE_SPAWN_EGG = registerItem("tadpole_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.TADPOLE));
    public static final Item TRADER_LLAMA_SPAWN_EGG = registerItem("trader_llama_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.TRADER_LLAMA));
    public static final Item TROPICAL_FISH_SPAWN_EGG = registerItem("tropical_fish_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.TROPICAL_FISH));
    public static final Item TURTLE_SPAWN_EGG = registerItem("turtle_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.TURTLE));
    public static final Item VEX_SPAWN_EGG = registerItem("vex_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.VEX));
    public static final Item VILLAGER_SPAWN_EGG = registerItem("villager_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.VILLAGER));
    public static final Item VINDICATOR_SPAWN_EGG = registerItem("vindicator_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.VINDICATOR));
    public static final Item WANDERING_TRADER_SPAWN_EGG = registerItem("wandering_trader_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.WANDERING_TRADER));
    public static final Item WARDEN_SPAWN_EGG = registerItem("warden_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.WARDEN));
    public static final Item WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.WITCH));
    public static final Item WITHER_SPAWN_EGG = registerItem("wither_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.WITHER));
    public static final Item WITHER_SKELETON_SPAWN_EGG = registerItem("wither_skeleton_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.WITHER_SKELETON));
    public static final Item WOLF_SPAWN_EGG = registerItem("wolf_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.WOLF));
    public static final Item ZOGLIN_SPAWN_EGG = registerItem("zoglin_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ZOGLIN));
    public static final Item CREAKING_SPAWN_EGG = registerItem("creaking_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.CREAKING));
    public static final Item ZOMBIE_SPAWN_EGG = registerItem("zombie_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ZOMBIE));
    public static final Item ZOMBIE_HORSE_SPAWN_EGG = registerItem("zombie_horse_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ZOMBIE_HORSE));
    public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = registerItem("zombie_villager_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ZOMBIE_VILLAGER));
    public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem("zombified_piglin_spawn_egg", ItemMonsterEgg::new, (new Item.Info()).spawnEgg(EntityTypes.ZOMBIFIED_PIGLIN));
    ...
    public static final Item SKELETON_SKULL = registerBlock(Blocks.SKELETON_SKULL, (block, item_info) -> {
        return new ItemBlockWallable(block, Blocks.SKELETON_WALL_SKULL, EnumDirection.DOWN, Waypoint.addHideAttribute(item_info));
    ...
    public static final Item WITHER_SKELETON_SKULL = registerBlock(Blocks.WITHER_SKELETON_SKULL, (block, item_info) -> {
        return new ItemBlockWallable(block, Blocks.WITHER_SKELETON_WALL_SKULL, EnumDirection.DOWN, Waypoint.addHideAttribute(item_info));
    ...
    public static final Item PLAYER_HEAD = registerBlock(Blocks.PLAYER_HEAD, (block, item_info) -> {
        return new ItemSkullPlayer(block, Blocks.PLAYER_WALL_HEAD, Waypoint.addHideAttribute(item_info));
    }, (new Item.Info()).rarity(EnumItemRarity.UNCOMMON).equippableUnswappable(EnumItemSlot.HEAD));
    public static final Item ZOMBIE_HEAD = registerBlock(Blocks.ZOMBIE_HEAD, (block, item_info) -> {
        return new ItemBlockWallable(block, Blocks.ZOMBIE_WALL_HEAD, EnumDirection.DOWN, Waypoint.addHideAttribute(item_info));
    }, (new Item.Info()).rarity(EnumItemRarity.UNCOMMON).equippableUnswappable(EnumItemSlot.HEAD));
    public static final Item CREEPER_HEAD = registerBlock(Blocks.CREEPER_HEAD, (block, item_info) -> {
        return new ItemBlockWallable(block, Blocks.CREEPER_WALL_HEAD, EnumDirection.DOWN, Waypoint.addHideAttribute(item_info));
    }, (new Item.Info()).rarity(EnumItemRarity.UNCOMMON).equippableUnswappable(EnumItemSlot.HEAD));
    public static final Item DRAGON_HEAD = registerBlock(Blocks.DRAGON_HEAD, (block, item_info) -> {
        return new ItemBlockWallable(block, Blocks.DRAGON_WALL_HEAD, EnumDirection.DOWN, Waypoint.addHideAttribute(item_info));
    ...
    public static final Item PIGLIN_HEAD = registerBlock(Blocks.PIGLIN_HEAD, (block, item_info) -> {
        return new ItemBlockWallable(block, Blocks.PIGLIN_WALL_HEAD, EnumDirection.DOWN, Waypoint.addHideAttribute(item_info));
    }, (new Item.Info()).rarity(EnumItemRarity.UNCOMMON).equippableUnswappable(EnumItemSlot.HEAD));
    ...
    public static final Item ENCHANTED_BOOK = registerItem("enchanted_book", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.RARE).component(DataComponents.STORED_ENCHANTMENTS, ItemEnchantments.EMPTY).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
    ...
    public static final Item COPPER_HORSE_ARMOR = registerItem("copper_horse_armor", (new Item.Info()).horseArmor(ArmorMaterials.COPPER));
    ...
    public static final Item MUSIC_DISC_LAVA_CHICKEN = registerItem("music_disc_lava_chicken", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.RARE).jukeboxPlayable(JukeboxSongs.LAVA_CHICKEN));
    ...
    public static final Item MUSIC_DISC_TEARS = registerItem("music_disc_tears", (new Item.Info()).stacksTo(1).rarity(EnumItemRarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.TEARS));
    ...
    public static final Item COPPER_GOLEM_STATUE = registerBlock(Blocks.COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
    public static final Item EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
    public static final Item WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
    public static final Item OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
    public static final Item WAXED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
    public static final Item WAXED_EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
    public static final Item WAXED_WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
    public static final Item WAXED_OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Info()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.a.STANDING)));
