...
public class DataComponents {
    ...
    public static final DataComponentType<TypedEntityData<EntityTypes<?>>> ENTITY_DATA = register("entity_data", (datacomponenttype_a) -> {
        return datacomponenttype_a.persistent(TypedEntityData.codec(EntityTypes.CODEC)).networkSynchronized(TypedEntityData.streamCodec(EntityTypes.STREAM_CODEC));
    });
    ...
    public static final DataComponentType<TypedEntityData<TileEntityTypes<?>>> BLOCK_ENTITY_DATA = register("block_entity_data", (datacomponenttype_a) -> {
        return datacomponenttype_a.persistent(TypedEntityData.codec(BuiltInRegistries.BLOCK_ENTITY_TYPE.byNameCodec())).networkSynchronized(TypedEntityData.streamCodec(ByteBufCodecs.registry(Registries.BLOCK_ENTITY_TYPE)));
    });
