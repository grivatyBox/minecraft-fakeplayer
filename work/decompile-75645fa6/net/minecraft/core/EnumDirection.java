...
public enum EnumDirection implements INamable {
    ...
    public static ImmutableList<EnumDirection.EnumAxis> axisStepOrder(Vec3D vec3d) {
        return Math.abs(vec3d.x) < Math.abs(vec3d.z) ? EnumDirection.YZX_AXIS_ORDER : EnumDirection.YXZ_AXIS_ORDER;
    }
