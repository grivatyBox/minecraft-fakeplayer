...
public class BuiltInRegistries {
    ...
    public static final IRegistry<DebugSubscription<?>> DEBUG_SUBSCRIPTION = registerSimple(Registries.DEBUG_SUBSCRIPTION, DebugSubscriptions::bootstrap);
    ...
    public static final IRegistry<IncomingRpcMethod> INCOMING_RPC_METHOD = registerSimple(Registries.INCOMING_RPC_METHOD, IncomingRpcMethods::bootstrap);
    public static final IRegistry<OutgoingRpcMethod<?, ?>> OUTGOING_RPC_METHOD = registerSimple(Registries.OUTGOING_RPC_METHOD, (iregistry) -> {
    ...
    public static final IRegistry<MapCodec<? extends Dialog>> DIALOG_TYPE = registerSimple(Registries.DIALOG_TYPE, DialogTypes::bootstrap);
    public static final IRegistry<MapCodec<? extends Action>> DIALOG_ACTION_TYPE = registerSimple(Registries.DIALOG_ACTION_TYPE, ActionTypes::bootstrap);
    public static final IRegistry<MapCodec<? extends InputControl>> INPUT_CONTROL_TYPE = registerSimple(Registries.INPUT_CONTROL_TYPE, InputControlTypes::bootstrap);
    public static final IRegistry<MapCodec<? extends DialogBody>> DIALOG_BODY_TYPE = registerSimple(Registries.DIALOG_BODY_TYPE, DialogBodyTypes::bootstrap);
    ...
    private static <T extends IRegistry<?>> void validate(IRegistry<T> iregistry) {
        iregistry.forEach((iregistry1) -> {
            ...
            if (iregistry1 instanceof RegistryBlocks) {
                ...
                Objects.requireNonNull(iregistry1.getValue(minecraftkey1), "Missing default of DefaultedMappedRegistry: " + String.valueOf(minecraftkey1));
            }
