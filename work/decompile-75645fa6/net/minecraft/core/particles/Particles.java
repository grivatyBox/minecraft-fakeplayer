...
public class Particles {
    ...
    public static final ParticleType COPPER_FIRE_FLAME = register("copper_fire_flame", false);
    ...
    public static final Particle<PowerParticleOption> DRAGON_BREATH = register("dragon_breath", false, PowerParticleOption::codec, PowerParticleOption::streamCodec);
    ...
    public static final Particle<SpellParticleOption> EFFECT = register("effect", false, SpellParticleOption::codec, SpellParticleOption::streamCodec);
    ...
    public static final Particle<ColorParticleOption> FLASH = register("flash", false, ColorParticleOption::codec, ColorParticleOption::streamCodec);
    ...
    public static final Particle<SpellParticleOption> INSTANT_EFFECT = register("instant_effect", false, SpellParticleOption::codec, SpellParticleOption::streamCodec);
