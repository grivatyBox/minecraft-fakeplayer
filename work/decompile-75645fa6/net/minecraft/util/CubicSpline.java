...
public interface CubicSpline<C, I extends BoundedFloatFunction<C>> extends BoundedFloatFunction<C> {
    ...
    static <C, I extends BoundedFloatFunction<C>> Codec<CubicSpline<C, I>> codec(Codec<I> codec) {
        ...
        Codec<a<C, I>> codec1 = RecordCodecBuilder.create((instance) -> {
            ...
            return instance.group(recordcodecbuilder, Codec.lazyInitialized(mutableobject::getValue).fieldOf("value").forGetter(a::value), Codec.FLOAT.fieldOf("derivative").forGetter(a::derivative)).apply(instance, (f, cubicspline, f1) -> {
                record a<C, I extends BoundedFloatFunction<C>>(float location, CubicSpline<C, I> value, float derivative) {
        ...
        Codec<CubicSpline.e<C, I>> codec2 = RecordCodecBuilder.create((instance) -> {
            return instance.group(codec.fieldOf("coordinate").forGetter(CubicSpline.e::coordinate), ExtraCodecs.nonEmptyList(codec1.listOf()).fieldOf("points").forGetter((cubicspline_e) -> {
                ...
                return CubicSpline.e.create(boundedfloatfunction, afloat, immutablelist_builder.build(), afloat1);
            });
        });
    ...
    static <C, I extends BoundedFloatFunction<C>> CubicSpline.b<C, I> builder(I i0) {
        return new CubicSpline.b<C, I>(i0);
    }

    static <C, I extends BoundedFloatFunction<C>> CubicSpline.b<C, I> builder(I i0, BoundedFloatFunction<Float> boundedfloatfunction) {
        return new CubicSpline.b<C, I>(i0, boundedfloatfunction);
    }

    @VisibleForDebug
    public static record e<C, I extends BoundedFloatFunction<C>>(I coordinate, float[] locations, List<CubicSpline<C, I>> values, float[] derivatives, float minValue, float maxValue) implements CubicSpline<C, I> {
        ...
        static <C, I extends BoundedFloatFunction<C>> CubicSpline.e<C, I> create(I i0, float[] afloat, List<CubicSpline<C, I>> list, float[] afloat1) {
            validateSizes(afloat, list, afloat1);
        ...
        private static <C, I extends BoundedFloatFunction<C>> void validateSizes(float[] afloat, List<CubicSpline<C, I>> list, float[] afloat1) {
        ...
        public float apply(C c0) {
            ...
            if (i < 0) {
                ...
                float f6 = boundedfloatfunction.apply(c0);
                float f7 = boundedfloatfunction1.apply(c0);
    ...
    @VisibleForDebug
    public static record c<C, I extends BoundedFloatFunction<C>>(float value) implements CubicSpline<C, I> {
    ...
    public static final class b<C, I extends BoundedFloatFunction<C>> {
        ...
        protected b(I i0) {
            this(i0, BoundedFloatFunction.IDENTITY);
        }

        protected b(I i0, BoundedFloatFunction<Float> boundedfloatfunction) {
