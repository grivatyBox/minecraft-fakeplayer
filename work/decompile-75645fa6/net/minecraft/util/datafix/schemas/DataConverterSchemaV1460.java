...
public class DataConverterSchemaV1460 extends DataConverterSchemaNamed {
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> map, Map<String, Supplier<TypeTemplate>> map1) {
        schema.registerType(false, DataConverterTypes.LEVEL, () -> {
            return DSL.optionalFields("CustomBossEvents", DSL.compoundList(DSL.optionalFields("Name", DataConverterTypes.TEXT_COMPONENT.in(schema))), DataConverterTypes.LIGHTWEIGHT_LEVEL.in(schema));
        });
        schema.registerType(false, DataConverterTypes.LIGHTWEIGHT_LEVEL, DSL::remainder);
        ...
        schema.registerType(false, DataConverterTypes.SAVED_DATA_WORLD_BORDER, DSL::remainder);
