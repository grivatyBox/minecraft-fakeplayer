...
public class AdvancementDisplay {
    ...
    private final Optional<ClientAsset.b> background;
    ...
    public AdvancementDisplay(ItemStack itemstack, IChatBaseComponent ichatbasecomponent, IChatBaseComponent ichatbasecomponent1, Optional<ClientAsset.b> optional, AdvancementFrameType advancementframetype, boolean flag, boolean flag1, boolean flag2) {
    ...
    public Optional<ClientAsset.b> getBackground() {
    ...
    private static AdvancementDisplay fromNetwork(RegistryFriendlyByteBuf registryfriendlybytebuf) {
        ...
        Optional<ClientAsset.b> optional = (i & 1) != 0 ? Optional.of(new ClientAsset.b(registryfriendlybytebuf.readResourceLocation())) : Optional.empty();
        boolean flag = (i & 2) != 0;
        boolean flag1 = (i & 4) != 0;
