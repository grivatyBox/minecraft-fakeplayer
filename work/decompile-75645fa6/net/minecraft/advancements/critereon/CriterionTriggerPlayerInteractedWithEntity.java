...
public class CriterionTriggerPlayerInteractedWithEntity extends CriterionTriggerAbstract<CriterionTriggerPlayerInteractedWithEntity.a> {
    ...
    public static record a(Optional<ContextAwarePredicate> player, Optional<CriterionConditionItem> item, Optional<ContextAwarePredicate> entity) implements CriterionTriggerAbstract.a {
        ...
        public static Criterion<CriterionTriggerPlayerInteractedWithEntity.a> equipmentSheared(Optional<ContextAwarePredicate> optional, CriterionConditionItem.a criterionconditionitem_a, Optional<ContextAwarePredicate> optional1) {
            return CriterionTriggers.PLAYER_SHEARED_EQUIPMENT.createCriterion(new CriterionTriggerPlayerInteractedWithEntity.a(optional, Optional.of(criterionconditionitem_a.build()), optional1));
        }

        public static Criterion<CriterionTriggerPlayerInteractedWithEntity.a> equipmentSheared(CriterionConditionItem.a criterionconditionitem_a, Optional<ContextAwarePredicate> optional) {
            return CriterionTriggers.PLAYER_SHEARED_EQUIPMENT.createCriterion(new CriterionTriggerPlayerInteractedWithEntity.a(Optional.empty(), Optional.of(criterionconditionitem_a.build()), optional));
        }
