...
public class DataWatcherRegistry {
    ...
    public static final DataWatcherSerializer<WeatheringCopper.a> WEATHERING_COPPER_STATE = DataWatcherSerializer.<WeatheringCopper.a>forValueType(WeatheringCopper.a.STREAM_CODEC);
    public static final DataWatcherSerializer<CopperGolemState> COPPER_GOLEM_STATE = DataWatcherSerializer.<CopperGolemState>forValueType(CopperGolemState.STREAM_CODEC);
    ...
    public static final DataWatcherSerializer<ResolvableProfile> RESOLVABLE_PROFILE = DataWatcherSerializer.<ResolvableProfile>forValueType(ResolvableProfile.STREAM_CODEC);
    ...
    static {
        ...
        registerSerializer(DataWatcherRegistry.COPPER_GOLEM_STATE);
        registerSerializer(DataWatcherRegistry.WEATHERING_COPPER_STATE);
        registerSerializer(DataWatcherRegistry.VECTOR3);
        registerSerializer(DataWatcherRegistry.QUATERNION);
        registerSerializer(DataWatcherRegistry.RESOLVABLE_PROFILE);
    }
}
