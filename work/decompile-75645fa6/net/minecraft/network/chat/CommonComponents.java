...
public class CommonComponents {
    ...
    public static final IChatBaseComponent GUI_COPY_TO_CLIPBOARD = IChatBaseComponent.translatable("chat.copy");
    ...
    public static final IChatBaseComponent GUI_RETURN_TO_MENU = IChatBaseComponent.translatable("menu.returnToMenu");
    ...
    public static IChatBaseComponent disconnectButtonLabel(boolean flag) {
        return flag ? CommonComponents.GUI_RETURN_TO_MENU : CommonComponents.GUI_DISCONNECT;
    }
