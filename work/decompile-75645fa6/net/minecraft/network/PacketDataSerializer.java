...
public class PacketDataSerializer extends ByteBuf {
    ...
    public <L, R> void writeEither(Either<L, R> either, StreamEncoder<? super PacketDataSerializer, L> streamencoder, StreamEncoder<? super PacketDataSerializer, R> streamencoder1) {
    ...
    public <L, R> Either<L, R> readEither(StreamDecoder<? super PacketDataSerializer, L> streamdecoder, StreamDecoder<? super PacketDataSerializer, R> streamdecoder1) {
    ...
    public void writeLpVec3(Vec3D vec3d) {
        LpVec3.write(this, vec3d);
    }
