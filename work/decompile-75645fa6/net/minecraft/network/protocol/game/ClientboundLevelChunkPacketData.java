...
public class ClientboundLevelChunkPacketData {
    ...
    public static void extractChunkData(PacketDataSerializer packetdataserializer, Chunk chunk) {
        ...
        if (packetdataserializer.writerIndex() != packetdataserializer.capacity()) {
            int i = packetdataserializer.capacity();

            throw new IllegalStateException("Didn't fill chunk buffer: expected " + i + " bytes, got " + packetdataserializer.writerIndex());
        }
    }
