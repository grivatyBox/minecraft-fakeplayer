...
public class GameTestHarnessInfo {
    ...
    public GameTestHarnessInfo prepareTestStructure() {
        TestInstanceBlockEntity testinstanceblockentity = this.createTestInstanceBlock((BlockPosition) Objects.requireNonNull(this.testBlockPos), this.extraRotation, this.level);
