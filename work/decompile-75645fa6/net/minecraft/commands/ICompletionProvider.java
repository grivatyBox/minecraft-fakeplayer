...
public interface ICompletionProvider {
    ...
    default void suggestRegistryElements(HolderLookup<?> holderlookup, ICompletionProvider.a icompletionprovider_a, SuggestionsBuilder suggestionsbuilder) {
    ...
    static <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> commandcontext, SuggestionsBuilder suggestionsbuilder, ResourceKey<? extends IRegistry<?>> resourcekey, ICompletionProvider.a icompletionprovider_a) {
        Object object = commandcontext.getSource();

        if (object instanceof ICompletionProvider icompletionprovider) {
            return icompletionprovider.suggestRegistryElements(resourcekey, icompletionprovider_a, suggestionsbuilder, commandcontext);
        } else {
