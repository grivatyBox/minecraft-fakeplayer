...
public class ArgumentProfile implements ArgumentType<ArgumentProfile.a> {
    ...
    public static Collection<NameAndId> getGameProfiles(CommandContext<CommandListenerWrapper> commandcontext, String s) throws CommandSyntaxException {
    ...
    private static ArgumentProfile.a parse(StringReader stringreader, boolean flag) throws CommandSyntaxException {
        if (stringreader.canRead() && stringreader.peek() == '@') {
            ...
            return (commandlistenerwrapper) -> {
                Optional<NameAndId> optional = commandlistenerwrapper.getServer().services().nameToIdCache().get(s);
    ...
    public static class b implements ArgumentProfile.a {
        ...
        @Override
        public Collection<NameAndId> getNames(CommandListenerWrapper commandlistenerwrapper) throws CommandSyntaxException {
            ...
            if (list.isEmpty()) {
                ...
                for (EntityPlayer entityplayer : list) {
                    list1.add(entityplayer.nameAndId());
                }
    ...
    public interface a {
        ...
        Collection<NameAndId> getNames(CommandListenerWrapper commandlistenerwrapper) throws CommandSyntaxException;
    }
}
