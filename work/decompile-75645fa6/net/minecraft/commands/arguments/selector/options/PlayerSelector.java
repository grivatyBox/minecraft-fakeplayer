    ...
    public static void bootStrap() {
        if (PlayerSelector.OPTIONS.isEmpty()) {
            ...
            register("distance", (argumentparserselector) -> {
                ...
                return argumentparserselector.getDistance() == null;
            ...
            register("level", (argumentparserselector) -> {
                ...
                return argumentparserselector.getLevel() == null;
            ...
            register("x_rotation", (argumentparserselector) -> {
                argumentparserselector.setRotX(CriterionConditionValue.c.fromReader(argumentparserselector.getReader()));
            }, (argumentparserselector) -> {
                return argumentparserselector.getRotX() == null;
            }, IChatBaseComponent.translatable("argument.entity.options.x_rotation.description"));
            register("y_rotation", (argumentparserselector) -> {
                argumentparserselector.setRotY(CriterionConditionValue.c.fromReader(argumentparserselector.getReader()));
            }, (argumentparserselector) -> {
                return argumentparserselector.getRotY() == null;
            ...
            register("nbt", (argumentparserselector) -> {
                ...
                argumentparserselector.addPredicate((entity) -> {
                    try (ProblemReporter.j problemreporter_j = new ProblemReporter.j(entity.problemPath(), PlayerSelector.LOGGER)) {
                        ...
                        return GameProfileSerializer.compareNbt(nbttagcompound, tagvalueoutput.buildResult(), true) != flag;
                    }
                });
            }, (argumentparserselector) -> {
                return true;
                ...
                if (!map.isEmpty()) {
                    argumentparserselector.addPredicate((entity) -> {
                        if (!(entity instanceof EntityPlayer entityplayer)) {
                            ...
                            AdvancementDataWorld advancementdataworld = entityplayer.level().getServer().getAdvancements();
