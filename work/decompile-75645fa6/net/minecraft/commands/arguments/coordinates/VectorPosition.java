...
public record VectorPosition(ArgumentParserPosition x, ArgumentParserPosition y, ArgumentParserPosition z) implements IVectorPosition {

    public static final VectorPosition ZERO_ROTATION = absolute(new Vec2F(0.0F, 0.0F));
