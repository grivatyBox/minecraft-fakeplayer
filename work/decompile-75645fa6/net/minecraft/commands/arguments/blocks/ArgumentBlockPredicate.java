        ...
        public boolean test(ShapeDetectorBlock shapedetectorblock) {
            ...
            if (!iblockdata.is(this.state.getBlock())) {
                ...
                if (this.nbt == null) {
                    ...
                    return tileentity != null && GameProfileSerializer.compareNbt(this.nbt, tileentity.saveWithFullMetadata((HolderLookup.a) shapedetectorblock.getLevel().registryAccess()), true);
                }
            }
        }
