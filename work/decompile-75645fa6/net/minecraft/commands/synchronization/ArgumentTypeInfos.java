...
public class ArgumentTypeInfos {
    ...
    public static ArgumentTypeInfo<?, ?> bootstrap(IRegistry<ArgumentTypeInfo<?, ?>> iregistry) {
        ...
        register(iregistry, "hex_color", HexColorArgument.class, SingletonArgumentInfo.contextFree(HexColorArgument::hexColor));
        ...
        register(iregistry, "loot_table", ResourceOrIdArgument.e.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::lootTable));
        register(iregistry, "loot_predicate", ResourceOrIdArgument.d.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::lootPredicate));
        register(iregistry, "loot_modifier", ResourceOrIdArgument.c.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::lootModifier));
        register(iregistry, "dialog", ResourceOrIdArgument.a.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::dialog));
