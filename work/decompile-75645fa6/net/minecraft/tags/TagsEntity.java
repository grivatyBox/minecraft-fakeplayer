...
public interface TagsEntity {
    ...
    TagKey<EntityTypes<?>> CAN_EQUIP_HARNESS = create("can_equip_harness");
    TagKey<EntityTypes<?>> CAN_WEAR_HORSE_ARMOR = create("can_wear_horse_armor");
    TagKey<EntityTypes<?>> FOLLOWABLE_FRIENDLY_MOBS = create("followable_friendly_mobs");
    TagKey<EntityTypes<?>> CANNOT_BE_PUSHED_ONTO_BOATS = create("cannot_be_pushed_onto_boats");
    TagKey<EntityTypes<?>> ACCEPTS_IRON_GOLEM_GIFT = create("accepts_iron_golem_gift");
    TagKey<EntityTypes<?>> CANDIDATE_FOR_IRON_GOLEM_GIFT = create("candidate_for_iron_golem_gift");
