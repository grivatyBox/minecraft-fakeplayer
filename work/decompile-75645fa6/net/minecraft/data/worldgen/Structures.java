...
public class Structures {
    ...
    public static void bootstrap(BootstrapContext<Structure> bootstrapcontext) {
        ...
        }))).build(), holdergetter1.getOrThrow(TrialChambersStructurePools.START), Optional.empty(), 20, UniformHeight.of(VerticalAnchor.absolute(-40), VerticalAnchor.absolute(-20)), false, Optional.empty(), new JigsawStructure.a(116), TrialChambersStructurePools.ALIAS_BINDINGS, new DimensionPadding(10), LiquidSettings.IGNORE_WATERLOGGING));
    }
}
